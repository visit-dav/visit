...
podman build --userns-uid-map 0:0:1 --userns-uid-map 1:1:1999 --userns-uid-map 65534:2047:1 \
    -f Dockerfile-ubuntu22 -t visitdev:3.5.0-ubuntu22

# optional: create a tar file for using the container at a later date.
# podman save visitdev:3.5.0-ubuntu22 > visitdev3.5.0-ubuntu22.tar

podman create --name dummy visitdev:3.5.0-ubuntu22

podman cp dummy:/home/visit/visit3_5_0.linux-x86_64.tar.gz ./visit3_5_0.linux-x86_64-ubuntu22.tar.gz
