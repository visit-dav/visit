...
TestOneFile(False,"../data/silo_%s_test_data/specmix_quad.silo"%SILO_MODE, "Material", "mir_curv2d")
TestSection("Unstructured, 2D")
TestOneFile(False,"../data/silo_%s_test_data/specmix_ucd.silo"%SILO_MODE, "Material", "mir_ucd2d")
TestSection("Rectilinear, 2D")
TestOneFile(True,"../data/silo_%s_test_data/rect2d.silo"%SILO_MODE, "mat1", "mir_rect2d")
TestSection("Rectilinear, 3D")
TestOneFile(True,"../data/silo_%s_test_data/rect3d.silo"%SILO_MODE, "mat1", "mir_rect3d")
