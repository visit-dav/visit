...
//
// Programmer: xml2java
// Creation:   Tue Jan 6 17:01:37 PST 2004
//
// Modifications:
//   
// ****************************************************************************
...
public class ViewerRPC extends AttributeSubject
{
    ...
    public final static int VIEWERRPCTYPE_SETVIEWEXTENTSTYPERPC = 88;
    public final static int VIEWERRPCTYPE_CLEARREFLINESRPC = 89;
    public final static int VIEWERRPCTYPE_SETRENDERINGATTRIBUTESRPC = 90;
    public final static int VIEWERRPCTYPE_DATABASEQUERYRPC = 91;
    public final static int VIEWERRPCTYPE_POINTQUERYRPC = 92;
    public final static int VIEWERRPCTYPE_LINEQUERYRPC = 93;
    public final static int VIEWERRPCTYPE_CLONEWINDOWRPC = 94;
    public final static int VIEWERRPCTYPE_SETMATERIALATTRIBUTESRPC = 95;
    public final static int VIEWERRPCTYPE_SETDEFAULTMATERIALATTRIBUTESRPC = 96;
    public final static int VIEWERRPCTYPE_RESETMATERIALATTRIBUTESRPC = 97;
    public final static int VIEWERRPCTYPE_SETPLOTDATABASESTATERPC = 98;
    public final static int VIEWERRPCTYPE_DELETEPLOTDATABASEKEYFRAMERPC = 99;
    public final static int VIEWERRPCTYPE_MOVEPLOTDATABASEKEYFRAMERPC = 100;
    public final static int VIEWERRPCTYPE_CLEARVIEWKEYFRAMESRPC = 101;
    public final static int VIEWERRPCTYPE_DELETEVIEWKEYFRAMERPC = 102;
    public final static int VIEWERRPCTYPE_MOVEVIEWKEYFRAMERPC = 103;
    public final static int VIEWERRPCTYPE_SETVIEWKEYFRAMERPC = 104;
    public final static int VIEWERRPCTYPE_OPENMDSERVERRPC = 105;
    public final static int VIEWERRPCTYPE_ENABLETOOLBARRPC = 106;
    public final static int VIEWERRPCTYPE_HIDETOOLBARSRPC = 107;
    public final static int VIEWERRPCTYPE_HIDETOOLBARSFORALLWINDOWSRPC = 108;
    public final static int VIEWERRPCTYPE_SHOWTOOLBARSRPC = 109;
    public final static int VIEWERRPCTYPE_SHOWTOOLBARSFORALLWINDOWSRPC = 110;
    public final static int VIEWERRPCTYPE_SAVEVIEWRPC = 111;
    public final static int VIEWERRPCTYPE_SETGLOBALLINEOUTATTRIBUTESRPC = 112;
    public final static int VIEWERRPCTYPE_SETPICKATTRIBUTESRPC = 113;
    public final static int VIEWERRPCTYPE_EXPORTCOLORTABLERPC = 114;
    public final static int VIEWERRPCTYPE_EXPORTENTIRESTATERPC = 115;
    public final static int VIEWERRPCTYPE_IMPORTENTIRESTATERPC = 116;
    public final static int VIEWERRPCTYPE_RESETPICKATTRIBUTESRPC = 117;
    public final static int VIEWERRPCTYPE_ADDANNOTATIONOBJECTRPC = 118;
    public final static int VIEWERRPCTYPE_HIDEACTIVEANNOTATIONOBJECTSRPC = 119;
    public final static int VIEWERRPCTYPE_DELETEACTIVEANNOTATIONOBJECTSRPC = 120;
    public final static int VIEWERRPCTYPE_RAISEACTIVEANNOTATIONOBJECTSRPC = 121;
    public final static int VIEWERRPCTYPE_LOWERACTIVEANNOTATIONOBJECTSRPC = 122;
    public final static int VIEWERRPCTYPE_SETANNOTATIONOBJECTOPTIONSRPC = 123;
    public final static int VIEWERRPCTYPE_SETDEFAULTANNOTATIONOBJECTLISTRPC = 124;
    public final static int VIEWERRPCTYPE_RESETANNOTATIONOBJECTLISTRPC = 125;
    public final static int VIEWERRPCTYPE_RESETPICKLETTERRPC = 126;
    public final static int VIEWERRPCTYPE_SETDEFAULTPICKATTRIBUTESRPC = 127;
    public final static int VIEWERRPCTYPE_CHOOSECENTEROFROTATIONRPC = 128;
    public final static int VIEWERRPCTYPE_SETCENTEROFROTATIONRPC = 129;
    public final static int VIEWERRPCTYPE_MAXRPC = 130;
