...
//
// Programmer: xml2java
// Creation:   Thu Feb 26 13:36:01 PST 2004
//
// Modifications:
//   
// ****************************************************************************
...
public class ViewerRPC extends AttributeSubject
{
    ...
    public final static int VIEWERRPCTYPE_SAVEVIEWRPC = 112;
    public final static int VIEWERRPCTYPE_SETGLOBALLINEOUTATTRIBUTESRPC = 113;
    public final static int VIEWERRPCTYPE_SETPICKATTRIBUTESRPC = 114;
    public final static int VIEWERRPCTYPE_EXPORTCOLORTABLERPC = 115;
    public final static int VIEWERRPCTYPE_EXPORTENTIRESTATERPC = 116;
    public final static int VIEWERRPCTYPE_IMPORTENTIRESTATERPC = 117;
    public final static int VIEWERRPCTYPE_RESETPICKATTRIBUTESRPC = 118;
    public final static int VIEWERRPCTYPE_ADDANNOTATIONOBJECTRPC = 119;
    public final static int VIEWERRPCTYPE_HIDEACTIVEANNOTATIONOBJECTSRPC = 120;
    public final static int VIEWERRPCTYPE_DELETEACTIVEANNOTATIONOBJECTSRPC = 121;
    public final static int VIEWERRPCTYPE_RAISEACTIVEANNOTATIONOBJECTSRPC = 122;
    public final static int VIEWERRPCTYPE_LOWERACTIVEANNOTATIONOBJECTSRPC = 123;
    public final static int VIEWERRPCTYPE_SETANNOTATIONOBJECTOPTIONSRPC = 124;
    public final static int VIEWERRPCTYPE_SETDEFAULTANNOTATIONOBJECTLISTRPC = 125;
    public final static int VIEWERRPCTYPE_RESETANNOTATIONOBJECTLISTRPC = 126;
    public final static int VIEWERRPCTYPE_RESETPICKLETTERRPC = 127;
    public final static int VIEWERRPCTYPE_SETDEFAULTPICKATTRIBUTESRPC = 128;
    public final static int VIEWERRPCTYPE_CHOOSECENTEROFROTATIONRPC = 129;
    public final static int VIEWERRPCTYPE_SETCENTEROFROTATIONRPC = 130;
    public final static int VIEWERRPCTYPE_MAXRPC = 131;
