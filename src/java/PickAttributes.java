...
//
// Programmer: xml2java
// Creation:   Tue Nov 18 13:59:32 PST 2003
//
// Modifications:
//   
// ****************************************************************************
...
public class PickAttributes extends AttributeSubject
{
    ...
    public PickAttributes(PickAttributes obj)
    {
        ...
        zoneCoords = new Vector(obj.zoneCoords.size());
        for(i = 0; i < obj.zoneCoords.size(); ++i)
            zoneCoords.addElement(new String((String)obj.zoneCoords.elementAt(i)));
    ...
    public void SetLogicalZone(boolean logicalZone_)
    {
        logicalZone = logicalZone_;
        Select(26);
    }

    public void SetZoneCoords(Vector zoneCoords_)
    {
    ...
    public boolean GetLogicalZone() { return logicalZone; }
    public Vector  GetZoneCoords() { return zoneCoords; }
    ...
    public void WriteAtts(CommunicationBuffer buf)
    {
        ...
        if(WriteSelect(26, buf))
            buf.WriteBool(logicalZone);
        if(WriteSelect(27, buf))
            buf.WriteStringVector(zoneCoords);
    }
    ...
    public void ReadAtts(int n, CommunicationBuffer buf)
    {
        for(int i = 0; i < n; ++i)
        {
            ...
            case 25:
                ...
                break;
            case 26:
                SetLogicalZone(buf.ReadBool());
                break;
            case 27:
                SetZoneCoords(buf.ReadStringVector());
                break;
            }
        }
    }
    ...
    private boolean logicalZone;
    private Vector  zoneCoords; // vector of String objects
}
