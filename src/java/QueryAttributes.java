...
//
// Programmer: xml2java
// Creation:   Tue Dec 2 18:17:22 PST 2003
//
// Modifications:
//   
// ****************************************************************************
...
public class QueryAttributes extends AttributeSubject
{
    ...
    public void SetCurrentPlotOnly(boolean currentPlotOnly_)
    {
    ...
    public boolean GetCurrentPlotOnly() { return currentPlotOnly; }
    ...
    public void ReadAtts(int n, CommunicationBuffer buf)
    {
        for(int i = 0; i < n; ++i)
        {
            ...
            case 9:
                ...
                break;
            case 10:
                SetCurrentPlotOnly(buf.ReadBool());
                break;
            }
        }
    }
    ...
    private boolean currentPlotOnly;
}
