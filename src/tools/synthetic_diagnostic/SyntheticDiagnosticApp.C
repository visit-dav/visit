...
// ****************************************************************************
// Method: SyntheticDiagnosticApp::SyntheticDiagnosticApp
//
// Purpose: 
//   Constructor.
//
...
//   Creation:   Wed Nov 24 08:07:28 EST 2010
//
// Modifications:
//
// ****************************************************************************
...
{
    viewer = v;
    setWindowTitle(tr("Synthetic Diagnostic Tool"));
    plotType = 0;
...
// ****************************************************************************
// Method: SyntheticDiagnosticApp::selectFile
//
//   Programmer: Dave Pugmire
//   Creation:   Wed Nov 24 08:07:28 EST 2010
//
...
void
SyntheticDiagnosticApp::changeVariable(const QString &var)
{
    viewer->Methods()->ChangeActivePlotsVar(var.toStdString());
}

void
SyntheticDiagnosticApp::changeVariableAndUpdate(const QString &var)
{
    changeVariable(var);
...
void
SyntheticDiagnosticApp::changePlotType(int val)
{
...
void
SyntheticDiagnosticApp::setNContours(int nc)
{
    int Contour = viewer->GetPlotIndex("Contour");
...
void
SyntheticDiagnosticApp::saveWindow()
{
...
void
SyntheticDiagnosticApp::execFile()
{
    // Get a filename from the file dialog.
    QString filename = QFileDialog::getOpenFileName(this,
               tr("Open File"),
