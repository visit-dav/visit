...
function bv_python_info
{
    ...
    export PYTHON3_URL=${PYTHON3_URL:-"https://www.python.org/ftp/python/3.7.7"}
    export PYTHON3_FILE_SUFFIX="tgz"
    export PYTHON3_VERSION=${PYTHON3_VERSION:-"3.7.7"}
    # TODO: May need logic for "m" suffix
    export PYTHON3_COMPATIBILITY_VERSION=${PYTHON3_COMPATIBILITY_VERSION:-"3.7m"}
    ...
    export PYTHON3_SHA256_CHECKSUM="8c8be91cd2648a1a0c251f04ea0bb4c2a5570feb9c45eaaa2241c785585b475a"
