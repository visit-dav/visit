...
function bv_conduit_info
{
    ...
    export CONDUIT_MD5_CHECKSUM="2f4188db6964a3ab51304f96be3b3253"
    export CONDUIT_SHA256_CHECKSUM="ecaa9668ebec5d4efad19b104d654a587c0adbd5f502128f89601408cb4d7d0c"
}
