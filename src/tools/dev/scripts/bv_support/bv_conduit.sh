...
{
    export CONDUIT_VERSION=${CONDUIT_VERSION:-"v0.9.8"}
    export CONDUIT_FILE=${CONDUIT_FILE:-"conduit-${CONDUIT_VERSION}-src-with-blt.tar.gz"}
    export CONDUIT_COMPATIBILITY_VERSION=${CONDUIT_COMPATIBILITY_VERSION:-"v0.9.8"}
    export CONDUIT_BUILD_DIR=${CONDUIT_BUILD_DIR:-"conduit-${CONDUIT_VERSION}"}
    export CONDUIT_SHA256_CHECKSUM="4f6e95b517030ee24d42e6065e295447647fa621c232b8c4590291852d9d26b1"
}
