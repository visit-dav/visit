...
//
//   Eric Brugger, Wed Oct 22 13:08:15 PDT 2025
//   Added a destructor to ViewerEnginePluginInfo to eliminate a memory leak.
//
// ****************************************************************************
...
class InfoGeneratorPlugin : public Plugin
{
  public:
    ...
    void WriteViewerEngineInfoSource(QTextStream &c)
    {
        ...
        QString funcName = name + "ViewerEnginePluginInfo::~" + name + "ViewerEnginePluginInfo";
        if(!ReplaceBuiltin(c, funcName))
        {
            c << "// ****************************************************************************" << Endl;
            c << "//  Method:  "<<name<< "ViewerEnginePluginInfo destructor" << Endl;
            c << "//" << Endl;
            c << "//  Programmer: generated by xml2info" << Endl;
            c << "//  Creation:   omitted"<< Endl;
            c << "//" << Endl;
            ...
            c << funcName << "()" << Endl;
            c << "{" << Endl;
            c << "    if (clientAtts)" << Endl;
            c << "    {" << Endl;
            c << "        delete clientAtts;" << Endl;
            c << "        clientAtts = NULL;" << Endl;
            c << "    }" << Endl;
            c << "    if (defaultAtts)" << Endl;
            c << "    {" << Endl;
            c << "        delete defaultAtts;" << Endl;
            c << "        defaultAtts = NULL;" << Endl;
            c << "    }" << Endl;
            c << "}" << Endl;
        }
        c << Endl;
        funcName = name + "ViewerEnginePluginInfo::InitializeGlobalObjects";
        if(!ReplaceBuiltin(c, funcName))
        {
            c << "// ****************************************************************************" << Endl;
            c << "//  Method:  "<<funcName << Endl;
