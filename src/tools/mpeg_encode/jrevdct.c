 ...
 * intermediate int32_mpeg_t array would be needed.)
 *
...
#define FIX(x)    ((int32_mpeg_t) ((x) * CONST_SCALE + 0.5)) 

/* Descale and correctly round an int32_mpeg_t value that's scaled by N bits.
...
/* Multiply an int32_mpeg_t variable by an int32_mpeg_t constant to yield an int32_mpeg_t result.
...
#define MULTIPLY(var,const)  (((INT16) (var)) * ((int32_mpeg_t) (const)))
#endif
#endif
...
*/
void reference_rev_dct _ANSI_ARGS_((int16_mpeg_t *block));
void mpeg_jrevdct_quick _ANSI_ARGS_((int16_mpeg_t *block));
...
mpeg_jrevdct_quick(data)
    DCTBLOCK data;
{
  int32_mpeg_t tmp0, tmp1, tmp2, tmp3;
  int32_mpeg_t tmp10, tmp11, tmp12, tmp13;
  int32_mpeg_t z1, z2, z3, z4, z5;
  int32_mpeg_t d0, d1, d2, d3, d4, d5, d6, d7;
