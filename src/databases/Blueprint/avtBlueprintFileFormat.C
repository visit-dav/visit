        ...
        if(field_ptr->has_child("association"))
        {
            ...
            if (n_topo.has_path("elements/shape"))
            {
                         ...
                         n_topo.has_child("subelements"))
                {
                    ...
                    // we need to add fields to this mesh
                    ...
                    if (elem_assoc)
                    {
                        // the element associated case is simple
                    }
                    else
                    {
                    ...
                    // 
                    Node &side_topo = intermediate_data["mixed_transformation/side_topo"];
                    Node &side_coords = intermediate_data["mixed_transformation/side_coords"];
                    Node &side_fields = intermediate_data["mixed_transformation/side_fields"];
                    Node &s2dmap = intermediate_data["mixed_transformation/s2dmap"];
                    Node &d2smap = intermediate_data["mixed_transformation/d2smap"];
                    Node options;
                    blueprint::mesh::topology::unstructured::generate_sides(
                        polyhedral_topo,
                        side_topo,
