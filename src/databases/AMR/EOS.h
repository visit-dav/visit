...
public:
  ...
  /*   return type; */
  /* } */
  virtual int   EOStype() const { return IdealEOS_type; }
...
public:
  ...
  virtual int   EOStype() const { return JwlEOS_type; }
  virtual float p_from_r_e( float r, float e );
  virtual float T_from_r_e( float r, float e );
  virtual float a_from_r_e( float r, float e );
...
{
public:
  SesameEOS() { /*strcpy(type, SesameEOS_type ); */ }
  //virtual const char* EOStype() const { return type; }
  virtual int   EOStype() const { return SesameEOS_type; }
  virtual float p_from_r_e( float r, float e ) { return 0.; }
  virtual float T_from_r_e( float r, float e ) { return 0.; }
  virtual float a_from_r_e( float r, float e ) { return 0.; }
