...
struct BaseFileInterface{
    ...
    enum DataType {H5_Float=0,H5_Double=1,H5_Int32=2,H5_Int64=3,H5_Byte=4,H5_Error=-1};
        ...
        virtual bool queryVariableNames(std::string q_string)=0;
        ...
        virtual void getData(const std::string variableName,int64_t time, void *data)=0;
        
        virtual bool getSpecificData(const std::string variablename,int64_t time,void *data,const std::vector<int32_t>& indices)=0;
        virtual bool getPointData(const std::string variablename,int64_t time,void *data,const std::vector<int32_t>& indices)=0;
