                                   ...
                                   int nList, int nBlock)
{
    ...
    for (int i = 0; i < nTimestep; i++)
    {
        ...
        {
            ffl[i][j] = new avtWavefrontOBJFileFormat(list[i*nBlock + j], readOptions);
        }
    }
...
// ****************************************************************************
//  Method: WavefrontOBJCommonPluginInfo::GetReadOptions
//
//  Purpose:
...
DBOptionsAttributes *
WavefrontOBJCommonPluginInfo::GetReadOptions() const
{
    return GetWavefrontOBJReadOptions();
}
