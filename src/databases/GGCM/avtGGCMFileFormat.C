...
avtGGCMFileFormat::GetMesh(int timestate, const char *meshname)
{
    ...
    grid[0] = ggcm_grid(grid_data, (int*) &this->dim[0], "gridx");
    grid[1] = ggcm_grid(grid_data, (int*) &this->dim[1], "gridy");
    grid[2] = ggcm_grid(grid_data, (int*) &this->dim[2], "gridz");
