/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkVisItModelMetadata.h
...
// .NAME vtkVisItModelMetadata - This class encapsulates the metadata
...
//   many files.
//
//   One way to initialize this object is by using vtkVisItExodusModel
...
#ifndef __vtkVisItModelMetadata_h
#define __vtkVisItModelMetadata_h
...
class vtkVisItModelMetadata : public vtkObject
{
public:
  vtkTypeMacro(vtkVisItModelMetadata, vtkObject);
  virtual void PrintSelf(ostream &os, vtkIndent indent);
  static vtkVisItModelMetadata *New();
  ...
  int MergeModelMetadata(const vtkVisItModelMetadata *em);
  ...
  int MergeGlobalInformation(const vtkVisItModelMetadata *em);
  ...
  vtkVisItModelMetadata *ExtractModelMetadata(vtkIdTypeArray *globalCellIdList,
                                         vtkDataSet *grid);

  // Description:
  //   Create and return a new metadata object containing only the
  //   global metadata of this metadata object.
  vtkVisItModelMetadata *ExtractGlobalMetadata();

  // Description:
  //   Free selected portions of the metadata when updating values
  //   in the vtkVisItModelMetadata object.  Resetting a particular field,
...
private:
  ...
  int InitializeFromIntArray(vtkVisItModelMetadata *sizes, vtkIntArray *ia);
  vtkIntArray *PackIntArray();
  int InitializeFromCharArray(vtkVisItModelMetadata *sizes,
  ...
  void ExtractCellsFromBlockData(vtkVisItModelMetadataSTLCloak *idset,
                                 vtkVisItModelMetadata *mmd);
  void ExtractNodesFromNodeSetData(vtkVisItModelMetadataSTLCloak *idset,
                                   vtkVisItModelMetadata *mmd);
  void ExtractSidesFromSideSetData(vtkVisItModelMetadataSTLCloak *idset,
                                   vtkVisItModelMetadata *mmd);
...
//ETX
  ...
  vtkVisItModelMetadataSTLCloak *BlockIdIndex;    // computed map
...
private:
  vtkVisItModelMetadata(const vtkVisItModelMetadata&); // Not implemented
  void operator=(const vtkVisItModelMetadata&); // Not implemented
};
#endif
