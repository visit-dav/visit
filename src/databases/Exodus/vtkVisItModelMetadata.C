...
/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkVisItModelMetadata.cxx
...
#include "vtkVisItModelMetadata.h"
...
vtkStandardNewMacro(vtkVisItModelMetadata);

#include <set>
#include <map>
#include <algorithm>

class vtkVisItModelMetadataSTLCloak
{
public:
  std::set<int> IntSet;
...
void vtkVisItModelMetadata::InitializeAllMetadata()
{
  this->Title = NULL;
...
void vtkVisItModelMetadata::InitializeAllIvars()
{
...
void vtkVisItModelMetadata::FreeAllGlobalData()
{
...
void vtkVisItModelMetadata::FreeAllLocalData()
{
...
void vtkVisItModelMetadata::FreeBlockDependentData()
{
...
void vtkVisItModelMetadata::FreeOriginalElementVariableNames()
{
  int i;
  FREELIST(this->OriginalElementVariableNames,
           this->OriginalNumberOfElementVariables);
}
void vtkVisItModelMetadata::FreeOriginalNodeVariableNames()
{
  int i;
  FREELIST(this->OriginalNodeVariableNames,
           this->OriginalNumberOfNodeVariables);
}
void vtkVisItModelMetadata::FreeUsedElementVariableNames()
{
  int i;
...
void vtkVisItModelMetadata::FreeAllMetadata()
{
  this->FreeAllLocalData();
  this->FreeAllGlobalData();
}
void vtkVisItModelMetadata::FreeAllIvars()
{
...
//
vtkVisItModelMetadata::vtkVisItModelMetadata()
{
...
void vtkVisItModelMetadata::Reset()
{
  this->FreeAllIvars();
  this->InitializeAllIvars();
}
...
void vtkVisItModelMetadata::SetInformationLines(int nlines, char **lines)
{
  int i;
...
void vtkVisItModelMetadata::AddInformationLine(char *line)
{
...
int vtkVisItModelMetadata::GetInformationLines(char ***lines) const
{
...
void vtkVisItModelMetadata::FreeQARecords()
{
...
void vtkVisItModelMetadata::SetQARecords(int nrecords, char *rec[][4])
{
  this->FreeQARecords();
...
void vtkVisItModelMetadata::AddQARecord(char *name, char *ver, char *recDate, char *recTime)
{
  typedef char *p4[4];
...
void vtkVisItModelMetadata::GetQARecord(int which,
...
void vtkVisItModelMetadata::SetTimeSteps(int num, float *steps)
{
...
void vtkVisItModelMetadata::SetCoordinateNames(int dimension, char **n)
{
  int i;
...
// Blocks
//-------------------------------------------------
int vtkVisItModelMetadata::GetBlockLocalIndex(int id)
{
  if (this->BlockIdIndex == NULL)
     {
     this->BlockIdIndex = new vtkVisItModelMetadataSTLCloak;
     }
...
void vtkVisItModelMetadata::SetBlockIds(int *b)
{
  FREE(this->BlockIds);

  this->BlockIds = b;
}
void vtkVisItModelMetadata::SetBlockElementType(char **t)
{
  int i;
...
void vtkVisItModelMetadata::SetBlockNodesPerElement(int *e)
{
  FREE(this->BlockNodesPerElement);

  this->BlockNodesPerElement = e;
}
void vtkVisItModelMetadata::SetBlockElementIdList(int *e)
{
  FREE(this->BlockElementIdList);

  this->BlockElementIdList = e;
}
void vtkVisItModelMetadata::SetBlockAttributes(float *a)
{
  FREE(this->BlockAttributes);

  this->BlockAttributes = a;
}
int vtkVisItModelMetadata::BuildBlockAttributesIndex()
{
...
int vtkVisItModelMetadata::BuildBlockElementIdListIndex()
{
  int nblocks = this->NumberOfBlocks;
...
int vtkVisItModelMetadata::SetBlockNumberOfElements(int *nelts)
{
...
int vtkVisItModelMetadata::SetBlockNumberOfAttributesPerElement(int *natts)
{
...
void vtkVisItModelMetadata::SetNodeSetIds(int *n)
{
  FREE(this->NodeSetIds);

  this->NodeSetIds = n;
}
void vtkVisItModelMetadata::SetNodeSetNodeIdList(int *n)
{
  FREE(this->NodeSetNodeIdList);

  this->NodeSetNodeIdList = n;
}
void vtkVisItModelMetadata::SetNodeSetDistributionFactors(float *d)
{
  FREE(this->NodeSetDistributionFactors);

  this->NodeSetDistributionFactors = d;
}
int vtkVisItModelMetadata::BuildNodeSetNodeIdListIndex()
{
...
int vtkVisItModelMetadata::BuildNodeSetDistributionFactorIndex()
{
  int nsets = this->NumberOfNodeSets;
...
int vtkVisItModelMetadata::SetNodeSetSize(int *size)
{
...
int vtkVisItModelMetadata::SetNodeSetNumberOfDistributionFactors(int *df)
{
...
void vtkVisItModelMetadata::SetSideSetIds(int *s)
{
  FREE(this->SideSetIds);

  this->SideSetIds = s;
}
void vtkVisItModelMetadata::SetSideSetElementList(int *s)
{
  FREE(this->SideSetElementList);

  this->SideSetElementList= s;
}
void vtkVisItModelMetadata::SetSideSetSideList(int *s)
{
  FREE(this->SideSetSideList);

  this->SideSetSideList= s;
}
void vtkVisItModelMetadata::SetSideSetNumDFPerSide(int *s)
{
  FREE(this->SideSetNumDFPerSide);

  this->SideSetNumDFPerSide= s;
}
int vtkVisItModelMetadata::SetSideSetSize(int *size)
{
...
int vtkVisItModelMetadata::SetSideSetNumberOfDistributionFactors(int *df)
{
...
void vtkVisItModelMetadata::SetSideSetDistributionFactors(float *d)
{
...
int vtkVisItModelMetadata::BuildSideSetListIndex()
{
...
int vtkVisItModelMetadata::BuildSideSetDistributionFactorIndex()
{
  int nsets = this->NumberOfSideSets;
...
void vtkVisItModelMetadata::SetBlockPropertyNames(int nprop, char **nms)
{
  int i;
...
void vtkVisItModelMetadata::SetBlockPropertyValue(int *v)
{
  FREE(this->BlockPropertyValue);

  this->BlockPropertyValue = v;
}
void vtkVisItModelMetadata::SetNodeSetPropertyNames(int nprops, char **nms)
{
  int i;
...
void vtkVisItModelMetadata::SetNodeSetPropertyValue(int *v)
{
  FREE(this->NodeSetPropertyValue);

  this->NodeSetPropertyValue = v;
}
void vtkVisItModelMetadata::SetSideSetPropertyNames(int nprops, char **nms)
{
  int i;
...
void vtkVisItModelMetadata::SetSideSetPropertyValue(int *v)
{
...
void vtkVisItModelMetadata::SetGlobalVariableNames(int num, char **n)
{
  int i;
...
void vtkVisItModelMetadata::SetGlobalVariableValue(float *f)
{
...
int vtkVisItModelMetadata::FindNameOnList(char *name, char **list, int listLen)
{
  int found = -1;
...
void vtkVisItModelMetadata::SetOriginalElementVariableNames(int nvars, char **names)
{
  this->FreeOriginalElementVariableNames();
...
void vtkVisItModelMetadata::SetElementVariableNames(int nvars, char **names)
{
  this->FreeUsedElementVariableNames();
...
void vtkVisItModelMetadata::SetElementVariableNumberOfComponents(int *comp)
{
  FREE(this->ElementVariableNumberOfComponents);
  this->ElementVariableNumberOfComponents = comp;
}
void vtkVisItModelMetadata::SetMapToOriginalElementVariableNames(int *map)
{
  FREE(this->MapToOriginalElementVariableNames);
  this->MapToOriginalElementVariableNames = map;
}

int vtkVisItModelMetadata::AddUGridElementVariable(char *ugridVarName,
                                    char *origName, int numComponents)
{
  ...
  else if (vtkVisItModelMetadata::FindNameOnList(ugridVarName,
...
int vtkVisItModelMetadata::RemoveUGridElementVariable(char *ugridVarName)
{
  int i;
  int maxVarNames = this->NumberOfElementVariables;

  int idx = vtkVisItModelMetadata::FindNameOnList(ugridVarName,
...
void vtkVisItModelMetadata::SetElementVariableInfo(int numOrigNames, char **origNames,
...
void vtkVisItModelMetadata::SetElementVariableTruthTable(int *n)
{
...
void vtkVisItModelMetadata::SetOriginalNodeVariableNames(int nvars, char **names)
{
  this->FreeOriginalNodeVariableNames();
...
void vtkVisItModelMetadata::SetNodeVariableNames(int nvars, char **names)
{
  this->FreeUsedNodeVariableNames();
...
void vtkVisItModelMetadata::SetNodeVariableNumberOfComponents(int *comp)
{
  FREE(this->NodeVariableNumberOfComponents);
  this->NodeVariableNumberOfComponents = comp;
}
void vtkVisItModelMetadata::SetMapToOriginalNodeVariableNames(int *map)
{
  FREE(this->MapToOriginalNodeVariableNames);
  this->MapToOriginalNodeVariableNames = map;
}

int vtkVisItModelMetadata::AddUGridNodeVariable(char *ugridVarName,
                                    char *origName, int numComponents)
{
  int i;
...
int vtkVisItModelMetadata::RemoveUGridNodeVariable(char *ugridVarName)
{
  int i;
...
void vtkVisItModelMetadata::SetNodeVariableInfo(int numOrigNames, char **origNames,
            int numNames, char **names, int *numComp, int *map)
{
...
// initialize this vtkVisItModelMetadata object with information packed
// into an unstructured grid (i.e. unpack).
//---------------------------------------------------------------

#define SIZE_ARRAY "vtkVisItModelMetadataSizes"
#define INT_ARRAY "vtkVisItModelMetadataInts"
#define FLOAT_ARRAY "vtkVisItModelMetadataFloats"
#define CHAR_ARRAY "vtkVisItModelMetadataChars"

void vtkVisItModelMetadata::RemoveMetadata(vtkDataSet *grid)
{
...
int vtkVisItModelMetadata::HasMetadata(vtkDataSet *grid)
{
  int hasMetadata = 0;
...
void vtkVisItModelMetadata::Pack(vtkDataSet *grid)
{
...
int vtkVisItModelMetadata::Unpack(vtkDataSet *grid, int deleteIt)
{
  vtkFieldData *fa = grid->GetFieldData();
  ...
  vtkVisItModelMetadata *temp = vtkVisItModelMetadata::New();
...
vtkIntArray *vtkVisItModelMetadata::PackSizeArray(int maxStr, int maxLine)
{
...
int vtkVisItModelMetadata::InitializeFromSizeArray(vtkIntArray *ia, int &maxS, int &maxL)
{
...
vtkIntArray *vtkVisItModelMetadata::PackIntArray()
{
...
int vtkVisItModelMetadata::InitializeFromIntArray(vtkVisItModelMetadata *sizes, vtkIntArray *ia)
{
...
char *vtkVisItModelMetadata::WriteLines(
...
vtkCharArray *vtkVisItModelMetadata::PackCharArray(int maxS, int maxL)
{
...
//
  ...
  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfInformationLines,
                        maxL, this->InformationLine);

  p = vtkVisItModelMetadata::WriteLines(p, this->Dimension,
                        maxS, this->CoordinateNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfBlocks,
                        maxS, this->BlockElementType);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfBlockProperties,
                        maxS, this->BlockPropertyNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfNodeSetProperties,
                        maxS, this->NodeSetPropertyNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfSideSetProperties,
                        maxS, this->SideSetPropertyNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfGlobalVariables,
                        maxS, this->GlobalVariableNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->OriginalNumberOfElementVariables,
                        maxS, this->OriginalElementVariableNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfElementVariables,
                        maxS, this->ElementVariableNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->OriginalNumberOfNodeVariables,
                        maxS, this->OriginalNodeVariableNames);

  p = vtkVisItModelMetadata::WriteLines(p, this->NumberOfNodeVariables,
...
char *vtkVisItModelMetadata::ReadLines(
...
int vtkVisItModelMetadata::InitializeFromCharArray(vtkVisItModelMetadata *sizes,
                          vtkCharArray *uca, int maxS, int maxL)
{
  ...
  if (num > 0)
    {
    uc = vtkVisItModelMetadata::ReadLines(&buf, num, maxL, uc);
  ...
  if (num)
    {
    uc = vtkVisItModelMetadata::ReadLines(&buf, num, maxS, uc);
    this->SetCoordinateNames(num, buf);
    }

  if (this->NumberOfBlocks)    // set in InitializeFromIntArray
    {
    uc = vtkVisItModelMetadata::ReadLines(&this->BlockElementType,
...
vtkFloatArray *vtkVisItModelMetadata::PackFloatArray()
{
...
int vtkVisItModelMetadata::InitializeFromFloatArray(vtkFloatArray *fa)
{
...
//---------------------------------------------------------------
// Merge and subset vtkVisItModelMetadata objects.  Because grids get
// merged and subsetted on their journey through the VTK reader and filters.
//---------------------------------------------------------------

int vtkVisItModelMetadata::AppendFloatLists(
    int numSubLists,
...
int vtkVisItModelMetadata::AppendIntegerLists(
    int numSubLists,
...
int vtkVisItModelMetadata::MergeIdLists(int numSubLists,
    int *id1, int *id1Idx, int id1Len,
...
int vtkVisItModelMetadata::MergeGlobalInformation(const vtkVisItModelMetadata *em)
{
  int i;

  if (!this->Title && em->GetTitle())
    {
    this->SetTitle(vtkVisItModelMetadata::StrDupWithNew(em->GetTitle()));
    }
  ...
  if (this->NumberOfQARecords < num)
    ...
    for (i=0; i<num; i++)
      ...
      qaRecs[i][0] = vtkVisItModelMetadata::StrDupWithNew(name);
      qaRecs[i][1] = vtkVisItModelMetadata::StrDupWithNew(version);
      qaRecs[i][2] = vtkVisItModelMetadata::StrDupWithNew(date);
      qaRecs[i][3] = vtkVisItModelMetadata::StrDupWithNew(time);
      }
  ...
  if (this->NumberOfInformationLines < num)
    ...
    char **lines = vtkVisItModelMetadata::CopyLines(newLines, num);
  ...
  if (this->CoordinateNames == NULL)
    {
    num = em->GetDimension();
    char **lines = vtkVisItModelMetadata::CopyLines(em->GetCoordinateNames(), num);
  ...
  if (nblocks == 0)
    ...
    this->SetBlockIds(
      vtkVisItModelMetadata::CopyInts(em->GetBlockIds(), num));
    ...
    this->SetBlockElementType(
      vtkVisItModelMetadata::CopyLines(em->GetBlockElementType(), num));

    this->SetBlockNodesPerElement(
      vtkVisItModelMetadata::CopyInts(em->GetBlockNodesPerElement(), num));

    this->SetBlockNumberOfAttributesPerElement(
      vtkVisItModelMetadata::CopyInts(em->GetBlockNumberOfAttributesPerElement(), num));
    }
  else if (nblocks != num)
    {
    ...
    for (i=0; i < nblocks; i++)
      ...
      if (!strcmp(this->BlockElementType[i], "NULL") &&
        ...
        this->BlockElementType[i] = vtkVisItModelMetadata::StrDupWithNew(types[i]);
  ...
  if (this->NumberOfNodeSets < num)
    {
    int *ids = vtkVisItModelMetadata::CopyInts(em->GetNodeSetIds(), num);
  ...
  if (this->NumberOfSideSets < num)
    {
    int *ids = vtkVisItModelMetadata::CopyInts(em->GetSideSetIds(), num);
  ...
  if (nvals > 0)
    ...
    if (nblockProp < num)
      ...
      this->SetBlockPropertyNames(num,
        vtkVisItModelMetadata::CopyLines(em->GetBlockPropertyNames(), num));

      this->SetBlockPropertyValue(
        vtkVisItModelMetadata::CopyInts(em->GetBlockPropertyValue(), nvals));
      }
  ...
  if (nvals > 0)
    ...
    if (nnsetProp < num)
      ...
      this->SetNodeSetPropertyNames(num,
        vtkVisItModelMetadata::CopyLines(em->GetNodeSetPropertyNames(), num));

      this->SetNodeSetPropertyValue(
        vtkVisItModelMetadata::CopyInts(em->GetNodeSetPropertyValue(), nvals));
      }
  ...
  if (nvals > 0)
    ...
    if (nssetProp < num)
      ...
      this->SetSideSetPropertyNames(num,
        vtkVisItModelMetadata::CopyLines(em->GetSideSetPropertyNames(), num));

      this->SetSideSetPropertyValue(
        vtkVisItModelMetadata::CopyInts(em->GetSideSetPropertyValue(), nvals));
      }
  ...
  if (num > this->NumberOfGlobalVariables)
    ...
    this->SetGlobalVariableNames(num,
        vtkVisItModelMetadata::CopyLines(em->GetGlobalVariableNames(), num));
  ...
  if (num > this->OriginalNumberOfElementVariables)
    {
    char **orig =
      vtkVisItModelMetadata::CopyLines(em->GetOriginalElementVariableNames(), num);

    int numvar = em->GetNumberOfElementVariables();
    char **varname =
      vtkVisItModelMetadata::CopyLines(em->GetElementVariableNames(), numvar);

    int *comp =
      vtkVisItModelMetadata::CopyInts(em->GetElementVariableNumberOfComponents(),
                                 numvar);
    int *map =
      vtkVisItModelMetadata::CopyInts(em->GetMapToOriginalElementVariableNames(),
                                 numvar);
  ...
  if (num > this->OriginalNumberOfNodeVariables)
    {
    char **orig =
      vtkVisItModelMetadata::CopyLines(em->GetOriginalNodeVariableNames(), num);

    int numvar = em->GetNumberOfNodeVariables();
    char **varname =
      vtkVisItModelMetadata::CopyLines(em->GetNodeVariableNames(), numvar);

    int *comp =
      vtkVisItModelMetadata::CopyInts(em->GetNodeVariableNumberOfComponents(), numvar);
    int *map =
      vtkVisItModelMetadata::CopyInts(em->GetMapToOriginalNodeVariableNames(), numvar);
...
//
// ASSUMPTION:
//   The vtkVisItModelMetadata object passed in comes from the same
...
int vtkVisItModelMetadata::MergeModelMetadata(const vtkVisItModelMetadata *em)
{
  int i, rc;
...
int *vtkVisItModelMetadata::CopyInts(int *vals, int num)
{
  int *newvals = NULL;
...
char **vtkVisItModelMetadata::CopyLines(char **lines, int num)
{
  char **newlines = NULL;
  ...
  for (int i=0; i<num; i++)
    {
    newlines[i]  = vtkVisItModelMetadata::StrDupWithNew(lines[i]);
    }

  return newlines;
}
void vtkVisItModelMetadata::ExtractCellsFromBlockData(vtkVisItModelMetadataSTLCloak *idset,
                          vtkVisItModelMetadata *mmd)
{
  int i, j, k;
  int nblocks, nelts;
...
void vtkVisItModelMetadata::ExtractNodesFromNodeSetData(vtkVisItModelMetadataSTLCloak *idset,
                          vtkVisItModelMetadata *mmd)
{
  int i, j;
  int nnsets, nnodes;
...
void vtkVisItModelMetadata::ExtractSidesFromSideSetData(vtkVisItModelMetadataSTLCloak *idset,
                          vtkVisItModelMetadata *mmd)
{
  int i, j;
  int nssets, nsides;
...
vtkVisItModelMetadata *vtkVisItModelMetadata::ExtractGlobalMetadata()
{
  vtkVisItModelMetadata *mmd = vtkVisItModelMetadata::New();
...
vtkVisItModelMetadata *vtkVisItModelMetadata::ExtractModelMetadata(
  vtkIdTypeArray *globalCellIdList,
  vtkDataSet *grid)
{
  int i;

  vtkVisItModelMetadata *em = this->ExtractGlobalMetadata();
  ...
  vtkVisItModelMetadataSTLCloak *cellIds =
    new vtkVisItModelMetadataSTLCloak;     // the cells we want to extract
  vtkVisItModelMetadataSTLCloak *nodeIds =
    new vtkVisItModelMetadataSTLCloak;     // the nodes they include
  ...
  if (!ca || !pa)
    {
    vtkErrorMacro(<< "vtkVisItModelMetadata::ExtractModelMetadata needs id arrays");
    em->Delete();
    return NULL;
    }
  ...
  if (!ica || !ipa)
    {
    vtkErrorMacro(<< "vtkVisItModelMetadata::ExtractModelMetadata id arrays not vtkIdType");
    em->Delete();
    return NULL;
    }
...
char *vtkVisItModelMetadata::StrDupWithNew(const char *s)
{
  char *newstr = NULL;
...
char *vtkVisItModelMetadata::FindOriginalNodeVariableName(const char *name, int component)
{
  int idx = -1;
...
int vtkVisItModelMetadata::ElementVariableIsDefinedInBlock(char *varname, int blockId)
{
  int i;
  int varIdx = -1;
...
char *vtkVisItModelMetadata::FindOriginalElementVariableName(const char *name, int component)
{
  int idx = -1;
...
void vtkVisItModelMetadata::ShowFloats(const char *what, int num, float *f)
{
  if (num < 1) return;
  if (!f) return;
  cout << what << endl;
...
void vtkVisItModelMetadata::ShowLines(const char *what, int num, char **l)
{
  if (num < 1) return;
  if (!l) return;
  cout << what << endl;
...
void vtkVisItModelMetadata::ShowIntArray(const char *what, int numx, int numy, int *id)
{
  if (numx < 1) return;
  if (numy < 1) return;
  if (id == NULL) return;
...
void vtkVisItModelMetadata::ShowInts(const char *what, int num, int *id)
{
  if (num < 1) return;
  if (!id) return;
  cout << what << endl;
...
void vtkVisItModelMetadata::ShowListsOfInts(const char *what, int *list,
...
void vtkVisItModelMetadata::ShowListsOfFloats(const char *what, float *list,
                              int nlists, int *idx, int len, int verbose)
{
  int i, j, ii;
  if (len == 0) return;
...
void vtkVisItModelMetadata::PrintLocalInformation()
{
  int verbose = 0;
...
void vtkVisItModelMetadata::PrintGlobalInformation()
{
  int i,j;
...
int vtkVisItModelMetadata::CalculateMaximumLengths(int &maxString, int &maxLine)
{
  int i;
  maxLine = 0;
  maxString = 0;
  ...
  // header file.  However the vtkVisItModelMetadata class must
...
void vtkVisItModelMetadata::PrintSelf(ostream& os, vtkIndent indent)
{
  int i;
