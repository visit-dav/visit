/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItXMLDataParser.cxx,v $
...
#include "vtkVisItBase64InputStream.h"
...
//----------------------------------------------------------------------------
vtkVisItXMLDataParser::vtkVisItXMLDataParser()
{
  this->NumberOfOpenElements = 0;
  this->OpenElementsSize = 10;
  this->OpenElements = new vtkVisItXMLDataElement*[this->OpenElementsSize];
  this->RootElement = 0;
  this->AppendedDataPosition = 0;
  this->AppendedDataMatched = 0;
  this->DataStream = 0;
  this->InlineDataStream = vtkVisItBase64InputStream::New();
  this->AppendedDataStream = vtkVisItBase64InputStream::New();
  ...
  this->ByteOrder = vtkVisItXMLDataParser::BigEndian;
#else
  this->ByteOrder = vtkVisItXMLDataParser::LittleEndian;
#endif
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLDataParser::Parse()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLDataParser::Parse(const char*)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLDataParser::Parse(const char*, unsigned int)
{
  vtkErrorMacro("Parsing from a string is not supported.");
  return 0;
}
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::StartElement(const char* name, const char** atts)
{
  vtkVisItXMLDataElement* element = vtkVisItXMLDataElement::New();
  ...
  if(strcmp(name, "AppendedData") == 0)
    ...
    if(encoding && (strcmp(encoding, "raw") == 0))
      {
      this->AppendedDataStream->Delete();
      this->AppendedDataStream = vtkVisItInputStream::New();
      }
    }
}

//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::EndElement(const char*)
{
  vtkVisItXMLDataElement* finished = this->PopOpenElement();
...
//----------------------------------------------------------------------------
int vtkVisItXMLDataParser::ParsingComplete()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLDataParser::CheckPrimaryAttributes()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::FindAppendedDataPosition()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::PushOpenElement(vtkVisItXMLDataElement* element)
{
  if(this->NumberOfOpenElements == this->OpenElementsSize)
    {
    unsigned int newSize = this->OpenElementsSize*2;
    vtkVisItXMLDataElement** newOpenElements = new vtkVisItXMLDataElement*[newSize];
    unsigned int i;
...
//----------------------------------------------------------------------------
vtkVisItXMLDataElement* vtkVisItXMLDataParser::PopOpenElement()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::FreeAllElements()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLDataParser::ParseBuffer(const char* buffer, unsigned int count)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::ReadCompressionHeader()
{
...
//----------------------------------------------------------------------------
unsigned int vtkVisItXMLDataParser::FindBlockSize(unsigned int block)
{
...
//----------------------------------------------------------------------------
unsigned char* vtkVisItXMLDataParser::ReadBlock(unsigned int block)
{
...
//----------------------------------------------------------------------------
vtkVisItXMLDataElement* vtkVisItXMLDataParser::GetRootElement()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLDataParser::UpdateProgress(float progress)
{
