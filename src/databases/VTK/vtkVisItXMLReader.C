/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItXMLReader.cxx,v $
...
vtkCxxRevisionMacro(vtkVisItXMLReader, "$Revision: 1.38.4.1 $");

//----------------------------------------------------------------------------
vtkVisItXMLReader::vtkVisItXMLReader()
{
  this->FileName = 0;
  this->Stream = 0;
  this->FileStream = 0;
  ...
  this->SelectionObserver->SetCallback(&vtkVisItXMLReader::SelectionModifiedCallback);
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
vtkDataSet* vtkVisItXMLReader::GetOutputAsDataSet()
{
  return this->GetOutputAsDataSet(0);
}

//----------------------------------------------------------------------------
vtkDataSet* vtkVisItXMLReader::GetOutputAsDataSet(int index)
{
...
int vtkVisItXMLReader::CanReadFileVersion(int major, int vtkNotUsed(minor))
{
  if (major > 0)
    {
    return 0;
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::CloseVTKFile()
{
  if(!this->Stream)
    {
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::CreateXMLParser()
{
  if(this->XMLParser)
    {
  ...
  this->XMLParser = vtkVisItXMLDataParser::New();
}

//----------------------------------------------------------------------------
void vtkVisItXMLReader::DestroyXMLParser()
{
  if(!this->XMLParser)
    {
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetupCompressor(const char* type)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::ReadXMLInformation()
{
  ...
  if(this->GetMTime() > this->ReadMTime)
    ...
    // Create the vtkVisItXMLParser instance used to parse the file.
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::RequestInformation(vtkInformation *request,
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::RequestData(vtkInformation *request, 
                              vtkInformationVector **vtkNotUsed(inputVector),
                              vtkInformationVector *outputVector)
{
  ...
  // Give the vtkVisItXMLParser instance its file back so that data section
  // reads will work.
  this->XMLParser->SetStream(this->Stream);
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::ReadXMLData()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::ReadVTKFile(vtkVisItXMLDataElement* eVTKFile)
{
  ...
  int i;
  vtkVisItXMLDataElement* ePrimary = 0;
  for(i=0; i < eVTKFile->GetNumberOfNestedElements(); ++i)
    {
    vtkVisItXMLDataElement* eNested = eVTKFile->GetNestedElement(i);
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::ReadPrimaryElement(vtkVisItXMLDataElement* ePrimary)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetupOutputData()
{
...
//----------------------------------------------------------------------------
vtkDataArray* vtkVisItXMLReader::CreateDataArray(vtkVisItXMLDataElement* da)
{
  int dataType = 0;
...
int vtkVisItXMLReader::CanReadFile(const char* name)
{
  ...
  // type.
  vtkVisItXMLFileReadTester* tester = vtkVisItXMLFileReadTester::New();
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::CanReadFileVersionString(const char* version)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::IntersectExtents(int* extent1, int* extent2, int* result)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::Min(int a, int b)
{
  return (a < b)? a : b;
}

//----------------------------------------------------------------------------
int vtkVisItXMLReader::Max(int a, int b)
{
  return (a > b)? a : b;
}

//----------------------------------------------------------------------------
void vtkVisItXMLReader::ComputePointDimensions(int* extent, int* dimensions)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::ComputePointIncrements(int* extent, vtkIdType* increments)
{
  increments[0] = 1;
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::ComputeCellDimensions(int* extent, int* dimensions)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::ComputeCellIncrements(int* extent, vtkIdType* increments)
{
...
//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLReader::GetStartTuple(int* extent, vtkIdType* increments,
                                      int i, int j, int k)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::ReadAttributeIndices(vtkVisItXMLDataElement* eDSA,
...
//----------------------------------------------------------------------------
char** vtkVisItXMLReader::CreateStringArray(int numStrings)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::DestroyStringArray(int numStrings, char** strings)
{
  int i;
  for(i=0; i < numStrings; ++i)
    {
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetDataArraySelections(vtkVisItXMLDataElement* eDSA,
                                          vtkDataArraySelection* sel)
{
  ...
  for(int i=0;i < numArrays;++i)
    {
    vtkVisItXMLDataElement* eNested = eDSA->GetNestedElement(i);
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::SetFieldDataInfo(vtkVisItXMLDataElement *eDSA, 
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::PointDataArrayIsEnabled(vtkVisItXMLDataElement* ePDA)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::CellDataArrayIsEnabled(vtkVisItXMLDataElement* eCDA)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SelectionModifiedCallback(vtkObject*, unsigned long,
                                             void* clientdata, void*)
{
  static_cast<vtkVisItXMLReader*>(clientdata)->Modified();
}

//----------------------------------------------------------------------------
int vtkVisItXMLReader::GetNumberOfPointArrays()
{
  return this->PointDataArraySelection->GetNumberOfArrays();
}

//----------------------------------------------------------------------------
const char* vtkVisItXMLReader::GetPointArrayName(int index)
{
  return this->PointDataArraySelection->GetArrayName(index);
}

//----------------------------------------------------------------------------
int vtkVisItXMLReader::GetPointArrayStatus(const char* name)
{
  return this->PointDataArraySelection->ArrayIsEnabled(name);
}

//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetPointArrayStatus(const char* name, int status)
{
  if(status)
    {
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::GetNumberOfCellArrays()
{
  return this->CellDataArraySelection->GetNumberOfArrays();
}

//----------------------------------------------------------------------------
const char* vtkVisItXMLReader::GetCellArrayName(int index)
{
  return this->CellDataArraySelection->GetArrayName(index);
}

//----------------------------------------------------------------------------
int vtkVisItXMLReader::GetCellArrayStatus(const char* name)
{
  return this->CellDataArraySelection->ArrayIsEnabled(name);
}

//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetCellArrayStatus(const char* name, int status)
{
  if(status)
    {
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::GetProgressRange(float* range)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetProgressRange(float* range, int curStep, int numSteps)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetProgressRange(float* range, int curStep,
                                    float* fractions)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::UpdateProgressDiscrete(float progress)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::ProcessRequest(vtkInformation* request,
...
//----------------------------------------------------------------------------
void vtkVisItXMLReader::SetNumberOfTimeSteps(int num)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLReader::IsTimeStepInArray(int timestep, int* timesteps, int length)
{
