/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItXMLFileReadTester.h,v $
...
=========================================================================*/
// .NAME vtkVisItXMLFileReadTester - Utility class for vtkVisItXMLReader and subclasses.
// .SECTION Description
// vtkVisItXMLFileReadTester reads the smallest part of a file necessary to
// determine whether it is a VTK XML file.  If so, it extracts the
// file type and version number.

#ifndef __vtkVisItXMLFileReadTester_h
#define __vtkVisItXMLFileReadTester_h

#include "vtkVisItXMLParser.h"

class vtkVisItXMLFileReadTester: public vtkVisItXMLParser
{
public:
  vtkTypeRevisionMacro(vtkVisItXMLFileReadTester,vtkVisItXMLParser);
  void PrintSelf(ostream& os, vtkIndent indent);  
  static vtkVisItXMLFileReadTester* New();
...
private:
  vtkVisItXMLFileReadTester(const vtkVisItXMLFileReadTester&);  // Not implemented.
  void operator=(const vtkVisItXMLFileReadTester&);  // Not implemented.
};
