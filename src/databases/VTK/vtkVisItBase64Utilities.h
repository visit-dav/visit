/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItBase64Utilities.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkVisItBase64Utilities - base64 encode and decode utilities.
// .SECTION Description
// vtkVisItBase64Utilities implements base64 encoding and decoding.

#ifndef __vtkVisItBase64Utilities_h
#define __vtkVisItBase64Utilities_h

#include "vtkObject.h"

class vtkVisItBase64Utilities : public vtkObject
{
public:
  static vtkVisItBase64Utilities *New();
  vtkTypeRevisionMacro(vtkVisItBase64Utilities,vtkObject);
...
protected:
  vtkVisItBase64Utilities() {};
  ~vtkVisItBase64Utilities() {};  
  
private:
  vtkVisItBase64Utilities(const vtkVisItBase64Utilities&);  // Not implemented.
  void operator=(const vtkVisItBase64Utilities&);  // Not implemented.
};
