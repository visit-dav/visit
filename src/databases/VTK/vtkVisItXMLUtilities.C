/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItXMLUtilities.cxx,v $
...
typedef vtkstd::vector<vtkVisItXMLDataElement*> vtkVisItXMLUtilitiesDataElementContainer;

vtkStandardNewMacro(vtkVisItXMLUtilities);
vtkCxxRevisionMacro(vtkVisItXMLUtilities, "$Revision: 1.5 $");
...
//----------------------------------------------------------------------------
inline int vtkVisItXMLUtilitiesEncodeEntities(unsigned char c, ostream &output)
{
  switch (c)
    {
    case '&':
...
//----------------------------------------------------------------------------
void vtkVisItXMLUtilities::EncodeString(const char *input, int input_encoding, 
                                   ...
                                   int special_entities)
{
  ...
  if (no_input_encoding || no_output_encoding)
    ...
    while (*str)
      {
      if (!vtkVisItXMLUtilitiesEncodeEntities(*str, output))
        {
        output << *str;
        }
      str++;
  ...
  if (output_encoding == VTK_ENCODING_UTF_8)
    ...
    if (input_encoding == VTK_ENCODING_US_ASCII || from_iso_8859)
      ...
      while (*str)
        {
        if (!special_entities || !vtkVisItXMLUtilitiesEncodeEntities(*str, output))
          {
          if (*str > 0x7F)
            {
#if 0
...
//----------------------------------------------------------------------------
void vtkVisItXMLUtilities::CollateAttributes(vtkVisItXMLDataElement *elem, 
                                        ostream &os,
                                        const char *sep)
{
  if (!elem)
...
//----------------------------------------------------------------------------
void vtkVisItXMLUtilities::FlattenElement(vtkVisItXMLDataElement *elem, 
                                     ostream &os,
                                     vtkIndent *indent,
                                     int indent_attributes)
{
  ...
  if (elem->GetNumberOfAttributes())
    ...
    if (indent && indent_attributes)
      ...
      memset(sep + 1, ' ', len);
      sep[len + 1] = '\0';
      vtkVisItXMLUtilities::CollateAttributes(elem, os, sep);
      delete [] sep;
      }
    else
      {
      vtkVisItXMLUtilities::CollateAttributes(elem, os);
      }
    }
  ...
  if (!nb_nested)
    ...
    for (int i = 0; i < nb_nested; i++)
      ...
      if (indent)
        ...
        vtkVisItXMLUtilities::FlattenElement(elem->GetNestedElement(i), 
                                        os, &next_indent);
        }
      else
        {
        vtkVisItXMLUtilities::FlattenElement(elem->GetNestedElement(i), os);
        }
      }
    if (indent)
      {
...
//----------------------------------------------------------------------------
int vtkVisItXMLUtilities::WriteElementToFile(vtkVisItXMLDataElement *elem, 
                                        const char *filename,
                                        vtkIndent *indent)
{
  if (!elem || !filename)
  ...
  vtkVisItXMLUtilities::FlattenElement(elem, os, indent);
...
vtkVisItXMLUtilities::ReadElementFromStream(istream &is, int encoding)
{
  vtkVisItXMLDataElement *res = NULL;
  vtkVisItXMLDataParser* xml_parser = vtkVisItXMLDataParser::New();
  ...
  if (xml_parser->Parse())
    ...
    vtkVisItXMLUtilities::UnFactorElements(res);
    }
...
//----------------------------------------------------------------------------
vtkVisItXMLDataElement*
vtkVisItXMLUtilities::ReadElementFromString(const char *str, int encoding)
{
  if (!str)
    {
    return 0;
  ...
  strstream strstr;
  strstr << str;
  vtkVisItXMLDataElement *res = 
    vtkVisItXMLUtilities::ReadElementFromStream(strstr, encoding);
...
//----------------------------------------------------------------------------
vtkVisItXMLDataElement*
vtkVisItXMLUtilities::ReadElementFromFile(const char *filename, int encoding)
{
  if (!filename)
    {
    return NULL;
  ...
  return vtkVisItXMLUtilities::ReadElementFromStream(is, encoding);
}

//----------------------------------------------------------------------------
void vtkVisItXMLUtilitiesFindSimilarElementsInternal(
  vtkVisItXMLDataElement *elem, 
  vtkVisItXMLDataElement *tree, 
  vtkVisItXMLUtilitiesDataElementContainer *results)
{
  ...
  if (elem->IsEqualTo(tree))
    ...
    for (int i = 0; i < tree->GetNumberOfNestedElements(); i++)
      {
      vtkVisItXMLUtilitiesFindSimilarElementsInternal(
...
//----------------------------------------------------------------------------
int vtkVisItXMLUtilities::FindSimilarElements(vtkVisItXMLDataElement *elem, 
                                         vtkVisItXMLDataElement *tree, 
                                         vtkVisItXMLDataElement ***results)
{
  ...
  vtkVisItXMLUtilitiesDataElementContainer *container = 
    new vtkVisItXMLUtilitiesDataElementContainer;
  
  vtkVisItXMLUtilitiesFindSimilarElementsInternal(elem, tree, container);
  ...
  if (size)
    ...
    *results = new vtkVisItXMLDataElement* [size];

    size = 0;
    for (vtkVisItXMLUtilitiesDataElementContainer::const_iterator 
...
//----------------------------------------------------------------------------
void vtkVisItXMLUtilities::FactorElements(vtkVisItXMLDataElement *tree)
{
  if (!tree)
    {
    return;
  ...
  vtkVisItXMLDataElement *pool = vtkVisItXMLDataElement::New();
  ...
  while (vtkVisItXMLUtilities::FactorElementsInternal(tree, tree, pool)) {};
...
//----------------------------------------------------------------------------
int vtkVisItXMLUtilities::FactorElementsInternal(vtkVisItXMLDataElement *tree,
                                            ...
                                            vtkVisItXMLDataElement *pool)
{
  ...
  vtkVisItXMLDataElement **similar_trees;
  int nb_of_similar_trees = vtkVisItXMLUtilities::FindSimilarElements(
  ...
  if (!nb_of_similar_trees)
    ...
    for (int i = 0; i < tree->GetNumberOfNestedElements(); i++)
      {
      res += vtkVisItXMLUtilities::FactorElementsInternal(
  ...
  vtkVisItXMLDataElement *factored = vtkVisItXMLDataElement::New();
  ...
  vtkVisItXMLDataElement *tree_copy = vtkVisItXMLDataElement::New();
...
//----------------------------------------------------------------------------
void vtkVisItXMLUtilities::UnFactorElements(vtkVisItXMLDataElement *tree)
{
  if (!tree)
    {
    return;
  ...
  vtkVisItXMLDataElement *pool = tree->FindNestedElementWithName(
  ...
  vtkVisItXMLUtilities::UnFactorElementsInternal(tree, pool);
...
//----------------------------------------------------------------------------
int vtkVisItXMLUtilities::UnFactorElementsInternal(vtkVisItXMLDataElement *tree,
                                              vtkVisItXMLDataElement *pool)
{
  if (!tree || !pool)
    {
  ...
  if (tree->GetName() &&
      !strcmp(tree->GetName(), VTK_XML_UTILITIES_FACTORED_REF_NAME))
    {
    vtkVisItXMLDataElement *original_tree = 
  ...
  for (int i = 0; i < tree->GetNumberOfNestedElements(); i++)
    {
    res += vtkVisItXMLUtilities::UnFactorElementsInternal(
