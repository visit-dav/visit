/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItBase64InputStream.cxx,v $
  Language:  C++
...
//----------------------------------------------------------------------------
vtkCxxRevisionMacro(vtkVisItBase64InputStream, "$Revision: 1.3 $");
vtkStandardNewMacro(vtkVisItBase64InputStream);

//----------------------------------------------------------------------------
vtkVisItBase64InputStream::vtkVisItBase64InputStream()
{
  this->BufferLength = 0;
}
...
//----------------------------------------------------------------------------
void vtkVisItBase64InputStream::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
inline int vtkVisItBase64InputStream::DecodeTriplet(unsigned char& c0,
                                               unsigned char& c1,
                                               unsigned char& c2)
{
  ...
  return vtkVisItBase64Utilities::DecodeTriplet(in[0], in[1], in[2], in[3],
                                           &c0, &c1, &c2);
}

//----------------------------------------------------------------------------
void vtkVisItBase64InputStream::StartReading()
{
...
//----------------------------------------------------------------------------
void vtkVisItBase64InputStream::EndReading()
{
}

//----------------------------------------------------------------------------
int vtkVisItBase64InputStream::Seek(unsigned long offset)
{
...
//----------------------------------------------------------------------------
unsigned long vtkVisItBase64InputStream::Read(unsigned char* data,
