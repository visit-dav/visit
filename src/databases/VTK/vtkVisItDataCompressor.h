/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItDataCompressor.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkVisItDataCompressor - Abstract interface for data compression classes.
// .SECTION Description
// vtkVisItDataCompressor provides a universal interface for data
...
#ifndef __vtkVisItDataCompressor_h
#define __vtkVisItDataCompressor_h

#include "vtkObject.h"

class vtkUnsignedCharArray;

class vtkVisItDataCompressor : public vtkObject
{
public:
  vtkTypeRevisionMacro(vtkVisItDataCompressor,vtkObject);
...
private:
  vtkVisItDataCompressor(const vtkVisItDataCompressor&);  // Not implemented.
  void operator=(const vtkVisItDataCompressor&);  // Not implemented.
};
