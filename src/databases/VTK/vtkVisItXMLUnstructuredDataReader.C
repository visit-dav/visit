...
//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::PrintSelf(ostream& os, vtkIndent indent)
{
...
::FindDataArrayWithName(vtkVisItXMLDataElement* eParent, const char* name)
{
  ...
  for(i=0;i < eParent->GetNumberOfNestedElements(); ++i)
    {
    vtkVisItXMLDataElement* eNested = eParent->GetNestedElement(i);
...
void vtkVisItXMLUnstructuredDataReaderCopyArray(TIn* in, TOut* out,
                                           vtkIdType length)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::SetupEmptyOutput()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::SetupNextPiece()
{
  this->StartPoint += this->NumberOfPoints[this->Piece];
}

//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::SetupUpdateExtent(int piece,
                                                     int numberOfPieces,
                                                     int ghostLevel)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::ReadXMLData()
{  
...
//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::SetupPieces(int numPieces)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLUnstructuredDataReader::DestroyPieces()
{
...
//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLUnstructuredDataReader::GetNumberOfPoints()
{
  return this->TotalNumberOfPoints;
}

//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLUnstructuredDataReader::GetNumberOfCells()
{
  return this->TotalNumberOfCells;
}

//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLUnstructuredDataReader::GetNumberOfPointsInPiece(int piece)
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLUnstructuredDataReader::ReadPieceData()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLUnstructuredDataReader::ReadCellArray(vtkIdType numberOfCells,
                                                vtkIdType totalNumberOfCells,
                                                vtkVisItXMLDataElement* eCells,
                                                vtkCellArray* outCells)
{
  ...
  vtkVisItXMLDataElement* eOffsets = this->FindDataArrayWithName(eCells, "offsets");
  if(!eOffsets)
    {
  ...
  vtkVisItXMLDataElement* eConn = this->FindDataArrayWithName(eCells, "connectivity");
  if(!eConn)
    {
    vtkErrorMacro("Cannot read cell connectivity from " << eCells->GetName()
                  << " in piece " << this->Piece
...
//----------------------------------------------------------------------------
int vtkVisItXMLUnstructuredDataReader::ReadArrayForPoints(vtkVisItXMLDataElement* da,
