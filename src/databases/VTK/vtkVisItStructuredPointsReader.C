...
//----------------------------------------------------------------------------
void vtkVisItStructuredPointsReader::SetOutput(vtkStructuredPoints *output)
{
  this->vtkSource::SetNthOutput(0, output);
}

//----------------------------------------------------------------------------
vtkStructuredPoints *vtkVisItStructuredPointsReader::GetOutput()
{
...
void vtkVisItStructuredPointsReader::ExecuteInformation()
{
...
void vtkVisItStructuredPointsReader::Execute()
{
  this->SetErrorCode( vtkErrorCode::NoError );
...
void vtkVisItStructuredPointsReader::PrintSelf(ostream& os, vtkIndent indent)
{
