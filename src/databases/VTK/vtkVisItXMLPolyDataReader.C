/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItXMLPolyDataReader.cxx,v $
...
vtkCxxRevisionMacro(vtkVisItXMLPolyDataReader, "$Revision: 1.9 $");
vtkStandardNewMacro(vtkVisItXMLPolyDataReader);

//----------------------------------------------------------------------------
vtkVisItXMLPolyDataReader::vtkVisItXMLPolyDataReader()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::SetOutput(vtkPolyData *output)
{
  this->GetExecutive()->SetOutputData(0, output);
}

//----------------------------------------------------------------------------
vtkPolyData* vtkVisItXMLPolyDataReader::GetOutput()
{
  return this->GetOutput(0);
}

//----------------------------------------------------------------------------
vtkPolyData* vtkVisItXMLPolyDataReader::GetOutput(int idx)
{
  return vtkPolyData::SafeDownCast( this->GetOutputDataObject(idx) );
}

//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLPolyDataReader::GetNumberOfVerts()
{
  return this->TotalNumberOfVerts;
}

//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLPolyDataReader::GetNumberOfLines()
{
  return this->TotalNumberOfLines;
}

//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLPolyDataReader::GetNumberOfStrips()
{
  return this->TotalNumberOfStrips;
}

//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLPolyDataReader::GetNumberOfPolys()
{
  return this->TotalNumberOfPolys;
}

//----------------------------------------------------------------------------
const char* vtkVisItXMLPolyDataReader::GetDataSetName()
{
  return "PolyData";
}

//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::GetOutputUpdateExtent(int& piece,
                                                 int& numberOfPieces,
                                                 int& ghostLevel)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::SetupOutputTotals()
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::SetupPieces(int numPieces)
{
  ...
  this->VertElements = new vtkVisItXMLDataElement*[numPieces];
  this->LineElements = new vtkVisItXMLDataElement*[numPieces];
  this->StripElements = new vtkVisItXMLDataElement*[numPieces];
  this->PolyElements = new vtkVisItXMLDataElement*[numPieces];
...
//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::DestroyPieces()
{
...
//----------------------------------------------------------------------------
vtkIdType vtkVisItXMLPolyDataReader::GetNumberOfCellsInPiece(int piece)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::SetupOutputData()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLPolyDataReader::ReadPiece(vtkVisItXMLDataElement* ePiece)
{
...
//----------------------------------------------------------------------------
void vtkVisItXMLPolyDataReader::SetupNextPiece()
{
...
//----------------------------------------------------------------------------
int vtkVisItXMLPolyDataReader::ReadPieceData()
{
  ...
  // Read the Verts.
  vtkVisItXMLDataElement* eVerts = this->VertElements[this->Piece];
  if(eVerts)
    {
...
//    if( needToRead )
  ...
  // Read the Lines.
  vtkVisItXMLDataElement* eLines = this->LineElements[this->Piece];
  if(eLines)
    {
//    int needToRead = this->CellsNeedToReadTimeStep(eNested, 
...
//    if( needToRead )
  ...
  // Read the Strips.
  vtkVisItXMLDataElement* eStrips = this->StripElements[this->Piece];
  if(eStrips)
    {
//    int needToRead = this->CellsNeedToReadTimeStep(eNested, 
...
//    if( needToRead )
  ...
  // Read the Polys.
  vtkVisItXMLDataElement* ePolys = this->PolyElements[this->Piece];
  if(ePolys)
    {
//    int needToRead = this->CellsNeedToReadTimeStep(eNested, 
...
//----------------------------------------------------------------------------
int vtkVisItXMLPolyDataReader::ReadArrayForCells(vtkVisItXMLDataElement* da,
...
//----------------------------------------------------------------------------
int vtkVisItXMLPolyDataReader::FillOutputPortInformation(int,
                                                 vtkInformation* info)
{
