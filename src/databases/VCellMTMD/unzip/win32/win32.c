...
static int SetSD(__G__ char *path, PVOLUMECAPS VolumeCaps, uch *eb_ptr, unsigned eb_len)    
    __GDEF    
    //char *path;    
...
static int EvalExtraFields(__G__ char *path, uch *ef_ptr, unsigned ef_len)    
    __GDEF    
    //char *path;    
    //uch *ef_ptr;    
    //unsigned ef_len;    
...
#pragma argsused    
#endif    
int test_NTSD(__G__ uch *eb, unsigned eb_size, uch *eb_ucptr, ulg eb_ucsize)    
    __GDEF    
    //uch *eb;    
    //unsigned eb_size;    
    //uch *eb_ucptr;    
...
static int getNTfiletime(__G__ FILETIME *pModFT, FILETIME *pAccFT, FILETIME *pCreFT)    
    __GDEF    
    //FILETIME *pModFT;    
    //FILETIME *pAccFT;    
    //FILETIME *pCreFT;    
...
static void maskDOSdevice(__G__ char *pathcomp)    
    __GDEF    
    //char *pathcomp;    
{    
/*---------------------------------------------------------------------------    
