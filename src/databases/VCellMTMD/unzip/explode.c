...
static int get_tree(__G__ unsigned *l, unsigned n)
     __GDEF
...
static int explode_lit(__G__ struct huft *tb, struct huft *tl, struct huft *td, int bb, int bl, int bd, unsigned bdl)
     __GDEF
...
static int explode_nolit(__G__ struct huft *tl, struct huft *td, int bl, int bd, unsigned bdl)
     __GDEF
