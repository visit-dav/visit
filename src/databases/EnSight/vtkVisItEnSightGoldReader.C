...
vtkCxxRevisionMacro(vtkVisItEnSightGoldReader, "$Revision: 1.53 $");
...
//----------------------------------------------------------------------------
vtkVisItEnSightGoldReader::vtkVisItEnSightGoldReader()
{
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadGeometryFile(const char* fileName, int timeStep)
{
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadMeasuredGeometryFile(const char* fileName,
                                                   int timeStep)
{
  char line[256], subLine[256];
  vtkPoints *newPoints;
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadScalarsPerNode(const char* fileName, const char* description,
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadVectorsPerNode(const char* fileName, const char* description,
                                             int timeStep, int measured)
{
  char line[256], formatLine[256], tempLine[256]; 
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadTensorsPerNode(const char* fileName, const char* description,
                                             int timeStep)
{
  char line[256];
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadScalarsPerElement(const char* fileName,
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadVectorsPerElement(const char* fileName,
                                                const char* description,
                                                int timeStep)
{
  char line[256];
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::ReadTensorsPerElement(const char* fileName,
                                                const char* description,
                                                int timeStep)
{
  char line[256];
...
//----------------------------------------------------------------------------
int vtkVisItEnSightGoldReader::CheckForUndefOrPartial(const char *line)
{
  char undefvar[16];
  ...
  if( r == 1)
    ...
    if( strcmp(undefvar, "undef") == 0 )
      ...
      switch( this->GetSectionType(line) )
        {
        case vtkVisItEnSightReader::COORDINATES:
          this->UndefPartial->UndefCoordinates = val;
          break;
        case vtkVisItEnSightReader::BLOCK:
          this->UndefPartial->UndefBlock = val;
          break;
        case vtkVisItEnSightReader::ELEMENT:
