...
void DarkStyle::polish(QApplication *app) {
  ...
  // loadstylesheet
  QFile qfDarkstyle("/Users/harrison37/Work/github/visit-dav/visit/src/winutil/darkstyle/darkstyle.qss");
  //QFile qfDarkstyle("/Users/harrison37/Work/github/visit-dav/style_adventure/darkstyle/vdarkstyle.qss");
  if (qfDarkstyle.open(QIODevice::ReadOnly | QIODevice::Text)) 
  {
    // set stylesheet
    //std::cout << "WWE GOT IT" << std::endl;
