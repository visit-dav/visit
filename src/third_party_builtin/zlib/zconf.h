...
#  define inflateBack           zlib_inflateBack
#  define inflateBackEnd        zlib_inflateBackEnd
...
#  define in_func               zlib_in_func
#  define out_func              zlib_out_func
#  define Byte                  zlib_Byte
#  define uInt                  zlib_uInt
#  define uLong                 zlib_uLong
#  define Bytef                 zlib_Bytef
#  define charf                 zlib_charf
#  define intf                  zlib_intf
#  define uIntf                 zlib_uIntf
#  define uLongf                zlib_uLongf
#  define voidpf                zlib_voidpf
#  define voidp                 zlib_voidp
#endif
