...
//
// Programmer: xml2atts
// Creation:   Wed Jul 20 15:14:00 PST 2005
//
// Modifications:
//   
// ****************************************************************************

ScatterAttributes::ScatterAttributes() : AttributeSubject("ibbddidisbbddidisbbddidisbbddiddiibsabb"),
...
ScatterAttributes::ScatterAttributes(const ScatterAttributes &obj) : AttributeSubject("ibbddidisbbddidisbbddidisbbddiddiibsabb")
{
...
ScatterAttributes::SelectAll()
{
    ...
    Select(32, (void *)&pointSizePixels);
    Select(33, (void *)&pointType);
    Select(34, (void *)&scaleCube);
    Select(35, (void *)&colorTableName);
    Select(36, (void *)&singleColor);
    Select(37, (void *)&foregroundFlag);
    Select(38, (void *)&legendFlag);
}
...
ScatterAttributes::GetFieldName(int index) const
{
    switch (index)
    {
        ...
        case 32:  return "Point size pixels";
        case 33:  return "Point Type";
        case 34:  return "Scale to cube";
        case 35:  return "Color table";
        case 36:  return "Single color";
        case 37:  return "Use Foreground ";
        case 38:  return "Legend";
...
ScatterAttributes::GetFieldType(int index) const
{
    switch (index)
    {
        ...
        case 32:  return FieldType_int;
        case 33:  return FieldType_enum;
        case 34:  return FieldType_bool;
        case 35:  return FieldType_colortable;
        case 36:  return FieldType_color;
...
ScatterAttributes::GetFieldTypeName(int index) const
{
    switch (index)
    {
        ...
        case 33:  return "enum";
        case 34:  return "bool";
        case 35:  return "colortable";
        case 36:  return "color";
        case 37:  return "bool";
        case 38:  return "bool";
        default:  return "invalid index";
    }
