...
//
// Programmer: xml2atts
// Creation:   Wed Jul 23 11:49:56 PDT 2003
//
// Modifications:
//   
// ****************************************************************************

VolumeAttributes::VolumeAttributes() : AttributeSubject("bbafbaisUbbfbfbfbfbi")
{
    legendFlag = true;
    lightingFlag = true;
...
VolumeAttributes::VolumeAttributes(const VolumeAttributes &obj) : AttributeSubject("bbafbaisUbbfbfbfbfbi")
{
    int i;
