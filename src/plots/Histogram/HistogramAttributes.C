...
{
    return OutputType_strings[(int)t];
}

std::string
HistogramAttributes::OutputType_ToString(int t)
{
    return OutputType_strings[t];
}
...
{
    return TwoDAmount_strings[(int)t];
}

std::string
HistogramAttributes::TwoDAmount_ToString(int t)
{
    return TwoDAmount_strings[t];
}
...
//
// Programmer: xml2atts
// Creation:   Thu Jun 26 23:52:13 PST 2003
//
// Modifications:
//   
// ****************************************************************************
