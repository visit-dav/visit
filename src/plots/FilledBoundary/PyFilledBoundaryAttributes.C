...
// Creation:   Thu Aug 25 09:13:26 PDT 2005
//
// ****************************************************************************
...
FilledBoundaryAttributes_setattr(PyObject *self, char *name, PyObject *args)
{
    ...
    if(strcmp(name, "colorType") == 0)
        ...
        retval = (FilledBoundaryAttributes_SetPointSizePixels(self, tuple) != NULL);
...
FilledBoundaryAttributes_print(PyObject *v, FILE *fp, int flags)
{
    ...
    else if(obj->data->GetPointType() == FilledBoundaryAttributes::Point)
