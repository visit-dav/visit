...
// Creation:   Wed Apr 14 16:54:19 PST 2004
//
// ****************************************************************************
...
PyFilledBoundaryAttributes_StringRepresentation(const FilledBoundaryAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    if(atts->GetColorType() == FilledBoundaryAttributes::ColorBySingleColor)
        {
             SNPRINTF(tmpStr, 10000, "colorType = ColorBySingleColor  # %s\n", colorType_names);
             str += tmpStr;
        }
    else if(atts->GetColorType() == FilledBoundaryAttributes::ColorByMultipleColors)
        {
             SNPRINTF(tmpStr, 10000, "colorType = ColorByMultipleColors  # %s\n", colorType_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "colorType = ColorByColorTable  # %s\n", colorType_names);
             str += tmpStr;
        }
   ...
   str += tmpStr;
    ...
    str += tmpStr;
    /* DOESN'T WORK -- assumes there is a PyColorAttributeList:
    { // new scope
    ...
    */
    ...
    if(atts->GetBoundaryType() == FilledBoundaryAttributes::Domain)
        {
             SNPRINTF(tmpStr, 10000, "boundaryType = Domain  # %s\n", boundaryType_names);
             str += tmpStr;
        }
    else if(atts->GetBoundaryType() == FilledBoundaryAttributes::Group)
        {
             SNPRINTF(tmpStr, 10000, "boundaryType = Group  # %s\n", boundaryType_names);
             str += tmpStr;
        }
    else if(atts->GetBoundaryType() == FilledBoundaryAttributes::Material)
        {
             SNPRINTF(tmpStr, 10000, "boundaryType = Material  # %s\n", boundaryType_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "boundaryType = Unknown  # %s\n", boundaryType_names);
             str += tmpStr;
        }
