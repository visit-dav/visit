...
FilledBoundaryAttributes::FilledBoundaryAttributes() : AttributeSubject("isbbiiaas*idbbib"),
...
FilledBoundaryAttributes::FilledBoundaryAttributes(const FilledBoundaryAttributes &obj) : AttributeSubject("isbbiiaas*idbbib")
{
