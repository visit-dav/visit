...
// Creation:   Mon May 3 16:17:44 PST 2004
//
// ****************************************************************************
...
PyPseudocolorAttributes_StringRepresentation(const PseudocolorAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    if(atts->GetCentering() == PseudocolorAttributes::Natural)
        {
             SNPRINTF(tmpStr, 10000, "centering = Natural  # %s\n", centering_names);
             str += tmpStr;
        }
    else if(atts->GetCentering() == PseudocolorAttributes::Nodal)
        {
             SNPRINTF(tmpStr, 10000, "centering = Nodal  # %s\n", centering_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "centering = Zonal  # %s\n", centering_names);
             str += tmpStr;
        }
    ...
    if(atts->GetScaling() == PseudocolorAttributes::Linear)
        {
             SNPRINTF(tmpStr, 10000, "scaling = Linear  # %s\n", scaling_names);
             str += tmpStr;
        }
    else if(atts->GetScaling() == PseudocolorAttributes::Log)
        {
             SNPRINTF(tmpStr, 10000, "scaling = Log  # %s\n", scaling_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "scaling = Skew  # %s\n", scaling_names);
             str += tmpStr;
        }
    ...
    if(atts->GetLimitsMode() == PseudocolorAttributes::OriginalData)
        {
             SNPRINTF(tmpStr, 10000, "limitsMode = OriginalData  # %s\n", limitsMode_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "limitsMode = CurrentPlot  # %s\n", limitsMode_names);
             str += tmpStr;
        }
