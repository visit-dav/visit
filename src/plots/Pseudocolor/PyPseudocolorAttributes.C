...
// Creation:   Thu Aug 25 09:24:00 PDT 2005
//
// ****************************************************************************
...
PseudocolorAttributes_print(PyObject *v, FILE *fp, int flags)
{
    ...
    else if(obj->data->GetPointType() == PseudocolorAttributes::Point)
        fprintf(fp, "pointType = Point  # %s\n", pointType_names);
    else
        fprintf(fp, "pointType = Sphere  # %s\n", pointType_names);
...
PyPseudocolorAttributes_StringRepresentation(const PseudocolorAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    if(atts->GetPointType() == PseudocolorAttributes::Box)
        ...
        {
             SNPRINTF(tmpStr, 1000, "pointType = Sphere  # %s\n", pointType_names);
             str += tmpStr;
        }
