...
// NOTES:  This is a copy of vtkExtractCellsByType which exists in
// VTK master but not 8.1.  Added here by same name as a reminder
// when we ugrade to newer vtk that we may want to subclass the
// original.
// There are minor changes to AddAllCellTypes and
// ExtractPolyDataCells, as well as to this header
// to remove the vtk api specification.
