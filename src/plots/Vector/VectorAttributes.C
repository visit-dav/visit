...
VectorAttributes::VectorAttributes() : AttributeSubject("biiiiddbbbasibbidd"),
...
VectorAttributes::VectorAttributes(const VectorAttributes &obj) : AttributeSubject("biiiiddbbbasibbidd")
{
...
VectorAttributes::SelectAll()
{
    ...
    Select(12, (void *)&vectorOrigin);
    Select(13, (void *)&minFlag);
    Select(14, (void *)&maxFlag);
    Select(15, (void *)&limitsMode);
    Select(16, (void *)&min);
    Select(17, (void *)&max);
}
...
VectorAttributes::GetFieldName(int index) const
{
    switch (index)
    {
        ...
        case 12:  return "Vector Origin";
        case 13:  return "Use min";
        case 14:  return "Use max";
        case 15:  return "Limits Mode";
        case 16:  return "Min";
        case 17:  return "Max";
