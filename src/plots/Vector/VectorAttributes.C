...
VectorAttributes::VectorAttributes() : AttributeSubject("biiiiddbbbasi"),
...
VectorAttributes::VectorAttributes(const VectorAttributes &obj) : AttributeSubject("biiiiddbbbasi")
{
