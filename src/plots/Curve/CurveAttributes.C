...
//
// Programmer: xml2atts
// Creation:   Thu Oct 27 15:33:45 PST 2005
//
// Modifications:
//   
// ****************************************************************************

CurveAttributes::CurveAttributes() : AttributeSubject("iiabsbdb"),
    color(0, 0, 0)
{
    lineStyle = 0;
    lineWidth = 0;
...
CurveAttributes::CurveAttributes(const CurveAttributes &obj) : AttributeSubject("iiabsbdb")
{
