...
//
// Programmer: xml2atts
// Creation:   Mon Oct 31 14:53:43 PST 2005
//
// Modifications:
//   
// ****************************************************************************

CurveAttributes::CurveAttributes() : AttributeSubject("iiabsbdbb"),
    color(0, 0, 0)
{
    lineStyle = 0;
    lineWidth = 0;
...
CurveAttributes::CurveAttributes(const CurveAttributes &obj) : AttributeSubject("iiabsbdbb")
{
