...
// Creation:   Wed Apr 6 17:28:11 PST 2005
//
// ****************************************************************************
...
#include <snprintf.h>
PyObject *
PyTopologyAttributes_StringRepresentation(const TopologyAttributes *atts)
{
   std::string str; 
   char tmpStr[1000]; 
    ...
    SNPRINTF(tmpStr, 1000, "minOpacity = %g\n", atts->GetMinOpacity());
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "minPlateauOpacity = %g\n", atts->GetMinPlateauOpacity());
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "maxPlateauOpacity = %g\n", atts->GetMaxPlateauOpacity());
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "maxOpacity = %g\n", atts->GetMaxOpacity());
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "tolerance = %g\n", atts->GetTolerance());
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "hitpercent = %g\n", atts->GetHitpercent());
    str += tmpStr;
...
{
    TopologyAttributesObject *obj = (TopologyAttributesObject *)v;
    return PyTopologyAttributes_StringRepresentation(obj->data);
}
