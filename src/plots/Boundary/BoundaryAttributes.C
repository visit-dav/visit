...
BoundaryAttributes::BoundaryAttributes() : AttributeSubject("isbbiiaas*idbidibs"),
...
BoundaryAttributes::BoundaryAttributes(const BoundaryAttributes &obj) : AttributeSubject("isbbiiaas*idbidibs")
{
