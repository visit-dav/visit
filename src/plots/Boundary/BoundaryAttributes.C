...
BoundaryAttributes::BoundaryAttributes() : AttributeSubject("isbbiiaas*idbbi"),
...
BoundaryAttributes::BoundaryAttributes(const BoundaryAttributes &obj) : AttributeSubject("isbbiiaas*idbbi")
{
...
void
BoundaryAttributes::SetDrawInternal(bool drawInternal_)
{
...
bool
BoundaryAttributes::GetDrawInternal() const
{
    return drawInternal;
}
