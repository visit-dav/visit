...
// Creation:   Wed May 7 01:00:37 PDT 2003
//
// ****************************************************************************
...
static PyObject *
BoundaryAttributes_SetDrawInternal(PyObject *self, PyObject *args)
{
    BoundaryAttributesObject *obj = (BoundaryAttributesObject *)self;
...
static PyObject *
BoundaryAttributes_GetDrawInternal(PyObject *self, PyObject *args)
{
    BoundaryAttributesObject *obj = (BoundaryAttributesObject *)self;
...
static struct PyMethodDef BoundaryAttributes_methods[] = {
    ...
    {"SetDrawInternal", BoundaryAttributes_SetDrawInternal, METH_VARARGS},
    {"GetDrawInternal", BoundaryAttributes_GetDrawInternal, METH_VARARGS},
...
BoundaryAttributes_getattr(PyObject *self, char *name)
{
    ...
    if(strcmp(name, "drawInternal") == 0)
        return BoundaryAttributes_GetDrawInternal(self, NULL);
...
BoundaryAttributes_setattr(PyObject *self, char *name, PyObject *args)
{
    ...
    if(strcmp(name, "colorType") == 0)
        ...
        retval = (BoundaryAttributes_SetSingleColor(self, args) != NULL);
        ...
        retval = (BoundaryAttributes_SetDrawInternal(self, tuple) != NULL);
...
// ****************************************************************************
//  Modifications:
//    Jeremy Meredith, Wed May  7 01:02:00 PDT 2003
//    Make defaultAtts point to the passed atts directly.
//    (copied from Kathleen's 12/2/2002 change in subset plot)
//
// ****************************************************************************
void
