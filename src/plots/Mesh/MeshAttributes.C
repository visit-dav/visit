...
//
// Programmer: xml2atts
// Creation:   Thu Oct 9 13:30:55 PST 2003
//
// Modifications:
//   
// ****************************************************************************

MeshAttributes::MeshAttributes() : AttributeSubject("biiabdidabbibsib"),
...
MeshAttributes::MeshAttributes(const MeshAttributes &obj) : AttributeSubject("biiabdidabbibsib")
{
...
MeshAttributes::CreateNode(DataNode *parentNode, bool forceAdd)
{
    ...
    if(!FieldsEqual(2, &defaultObject))
    {
        ...
        if(meshColor.CreateNode(meshColorNode, true))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(7, &defaultObject))
    {
        ...
        if(opaqueColor.CreateNode(opaqueColorNode, true))
        {
            addToParent = true;
