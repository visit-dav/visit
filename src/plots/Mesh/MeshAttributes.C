...
MeshAttributes::SelectAll()
{
    ...
    Select(ID_pointAtts,               (void *)&pointAtts);
}
...
MeshAttributes::CreateNode(DataNode *parentNode, bool completeSave, bool forceAdd)
{
    ...
    if(completeSave || !FieldsEqual(ID_pointAtts, &defaultObject))
    {
        DataNode *pointAttsNode = new DataNode("pointAtts");
        if(pointAtts.CreateNode(pointAttsNode, completeSave, false))
        {
            addToParent = true;
            node->AddNode(pointAttsNode);
        }
        else
            delete pointAttsNode;
    }
...
MeshAttributes::SetFromNode(DataNode *parentNode)
{
    ...
    if((node = searchNode->GetNode("pointAtts")) != 0)
        pointAtts.SetFromNode(node);
}
...
void
MeshAttributes::SetPointAtts(const PointGlyphAttributes &pointAtts_)
{
...
const PointGlyphAttributes &
MeshAttributes::GetPointAtts() const
{
    return pointAtts;
}

PointGlyphAttributes &
MeshAttributes::GetPointAtts()
{
    return pointAtts;
}
...
void
MeshAttributes::SelectPointAtts()
{
    Select(ID_pointAtts, (void *)&pointAtts);
}
...
MeshAttributes::GetFieldName(int index) const
{
    ...
    case ID_pointAtts:               return "pointAtts";
...
MeshAttributes::GetFieldType(int index) const
{
    ...
    case ID_pointAtts:               return FieldType_att;
...
MeshAttributes::FieldsEqual(int index_, const AttributeGroup *rhs) const
{
    ...
    case ID_pointAtts:
        {  // new scope
        retval = (pointAtts == obj.pointAtts);
        }
        break;
