...
# paths that find_program will search through.
...
foreach(SystemPrefixDir ${CMAKE_SYSTEM_PREFIX_PATH})
  # this module in Cmake 2.8.3 has this:
  #  foreach(MpiPackageDir ${_MPI_PREFIX_PATH})
  # which does not allow for the places set in _MPI_PACKAGE_DIR above to
  # be searched
...
if (MPI_INCLUDE_PATH AND MPI_LIBRARY)
  ...
  set(MPI_FOUND FALSE CACHE BOOL "")
endif (MPI_INCLUDE_PATH AND MPI_LIBRARY)
