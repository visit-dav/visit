...
private slots:
    ...
    void processProfileNameText();
    void processDirectoryText();
    ...
    void processSublaunchPreCmdText();
    void processSublaunchPostCmdText();
    ...
    void hostAliasesChanged();
    void hostNicknameChanged();
    ...
    void gatewayHostChanged();
    void clientHostNameMethodChanged(int);
    void clientHostNameChanged();
