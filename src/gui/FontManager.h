...
//   like in the sample text as a sort of preview of what the font actually looks
//   like. In particular, the font manager functions implimented here have NOTHING
//   TO DO with the font the GUI uses for its widgets.
//
