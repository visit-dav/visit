...
IF (MSVC_VERSION)
  ...
  SET(HDF4VER "4.2.6")
  SET(PYSIDEVER "1.1.1")
  OPTION(HDF4_LIBNAMES_AFFIX_DLL "Is 'dll' appended to hdf4 libnames" true)
  OPTION(JPEG_LIBNAME_PREFIX_LIB "Is 'lib' prefixed to jpeg libname" true)
  IF (NOT MSVC_VERSION LESS 1700)
      SET(VISIT_MSVC_VERSION "MSVC2012")
      SET(PYTHONVER "2.7.5")
      SET(JPEGVER "9")
      OPTION(JPEG_LIBNAME_PREFIX_LIB "Is 'lib' prefixed to jpeg libname" false)
      SET(ZLIBVER "1.2.8")
      SET(BOXLIBVER "2011.04.28")
      SET(CGNSVER "3.1.4")
      SET(HDF4VER "4.2.9")
      OPTION(HDF4_LIBNAMES_AFFIX_DLL "Is 'dll' appended to hdf4 libnames" false)
      SET(PYSIDEVER "1.2.1")
