...
VISIT_OPTION_DEFAULT(VISIT_HDF5_LIBDEP  zlib szip TYPE STRING)
...
VISIT_OPTION_DEFAULT(VISIT_CONDUIT_LIBDEP hdf5 TYPE STRING)

##
## NETCDF
##
VISIT_OPTION_DEFAULT(VISIT_NETCDF_DIR   ${VISITHOME}/netcdf/4.5.0)
VISIT_OPTION_DEFAULT(VISIT_NETCDF_LIBDEP hdf5 TYPE STRING)
...
VISIT_OPTION_DEFAULT(VISIT_CGNS_LIBDEP  hdf5 TYPE STRING)
...
VISIT_OPTION_DEFAULT(VISIT_MFEM_LIBDEP conduit zlib TYPE STRING)
...
VISIT_OPTION_DEFAULT(VISIT_SILO_LIBDEP  hdf5 TYPE STRING)
...
##
if(USE_VTK94)
    VISIT_OPTION_DEFAULT(VISIT_XDMF_DIR ${VISITHOME}/xdmf-vtk9.4/2.1.1)
else()
    VISIT_OPTION_DEFAULT(VISIT_XDMF_DIR ${VISITHOME}/Xdmf/2.1.1)
endif()
VISIT_OPTION_DEFAULT(VISIT_XDMF_LIBDEP hdf5 VTK::libxml2 TYPE STRING)
...
VISIT_OPTION_DEFAULT(VISIT_ADIOS2_LIBDEP blosc2 hdf5)
VISIT_OPTION_DEFAULT(VISIT_ADIOS2_PAR_DIR ${VISITHOME}/adios2/${ADIOS2_VERSION})
VISIT_OPTION_DEFAULT(VISIT_ADIOS2_PAR_LIBDEP blosc2 hdf5)
