...
VISIT_OPTION_DEFAULT(VISIT_MFEM_LIBDEP ${VISIT_CONDUIT_LIBDEP}
    ZLIB_LIBRARY_DIR ZLIB_LIB TYPE STRING)
...
## VTK-m
##
VISIT_OPTION_DEFAULT(VISIT_VTKM_DIR     ${VISITHOME}/vtkm/v1.7.0)

##
## VTK-h
##
VISIT_OPTION_DEFAULT(VISIT_VTKH_DIR     ${VISITHOME}/vtkh/v0.8.0)
...
## XDMF
##
VISIT_OPTION_DEFAULT(VISIT_XDMF_DIR ${VISITHOME}/Xdmf/2.1.1-VTK9)
VISIT_OPTION_DEFAULT(VISIT_XDMF_LIBDEP 
    HDF5_LIBRARY_DIR HDF5_LIB ${VISIT_HDF5_LIBDEP}
    ${VISIT_VTK_DIR}/lib vtklibxml2-${VTK_MAJOR_VERSION}.${VTK_MINOR_VERSION}
    TYPE STRING)
