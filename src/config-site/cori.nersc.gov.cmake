#/usr/common/software/visit/installs/visit_3rdparty/3.0.1/cmake/3.9.3/linux-x86_64_gcc-8.2/bin/cmake
##
## ../src/tools/dev/scripts/build_visit generated host.cmake
## created: Tue Aug 13 15:08:38 PDT 2019
## system: Linux cori06 4.12.14-150.22-default #1 SMP Tue Jun 11 09:07:10 UTC 2019 (66821da) x86_64 x86_64 x86_64 GNU/Linux
## by: swowner

##
## Setup VISITHOME & VISITARCH variables.
##
SET(VISITHOME /usr/common/software/visit/installs/visit_3rdparty/3.0.1)
SET(VISITARCH linux-x86_64_gcc-8.2)

VISIT_OPTION_DEFAULT(VISIT_INSTALL_PROFILES_TO_HOSTS "nersc" TYPE STRING)
VISIT_OPTION_DEFAULT(CMAKE_INSTALL_PREFIX /usr/common/software/visit)
...
VISIT_OPTION_DEFAULT(VISIT_MPI_CXX_FLAGS "-I/opt/cray/pe/mpt/7.7.6/gni/mpich-gnu/8.2/include" TYPE STRING)
VISIT_OPTION_DEFAULT(VISIT_MPI_C_FLAGS   "-I/opt/cray/pe/mpt/7.7.6/gni/mpich-gnu/8.2/include" TYPE STRING)
VISIT_OPTION_DEFAULT(VISIT_MPI_LD_FLAGS  "-L/opt/cray/pe/mpt/7.7.6/gni/mpich-gnu/8.2/lib -L/opt/cray/pe/pmi/5.0.14/lib64 -L/opt/cray/alps/6.6.50-7.0.0.1_3.30__g962f7108.ari/lib64" TYPE STRING)
VISIT_OPTION_DEFAULT(VISIT_MPI_LIBS     mpich)
VISIT_OPTION_DEFAULT(VISIT_PARALLEL_RPATH  "/opt/cray/pe/mpt/7.7.6/gni/mpich-gnu/8.2/lib")
...
## ZLIB
##
VISIT_OPTION_DEFAULT(VISIT_ZLIB_DIR ${VISITHOME}/zlib/1.2.9/${VISITARCH})
...
VISIT_OPTION_DEFAULT(VISIT_HDF5_LIBDEP ${VISITHOME}/szip/2.1/${VISITARCH}/lib sz ${VISITHOME}/zlib/1.2.9/${VISITARCH}/lib z TYPE STRING)
...
VISIT_OPTION_DEFAULT(VISIT_MFEM_LIBDEP ${VISIT_CONDUIT_LIBDEP} ${VISITHOME}/zlib/1.2.9/${VISITARCH}/lib z TYPE STRING)
