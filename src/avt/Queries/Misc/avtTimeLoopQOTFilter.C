...
// ****************************************************************************
//  Method: avtTimeLoopQOTFilter destructor
//
//  Programmer: Kathleen Bonnell
//  Creation:   March 15, 2004
//
...
avtTimeLoopQOTFilter::~avtTimeLoopQOTFilter()
{
}


// ****************************************************************************
//  Method:  avtTimeLoopQOTFilter::Create
//
//  Purpose:
...
avtFilter *
avtTimeLoopQOTFilter::Create(const AttributeGroup *atts)
{
    return new avtTimeLoopQOTFilter(atts);
}


// ****************************************************************************
//  Method: avtTimeLoopQOTFilter::Execute
//
//  Purpose:
...
void
avtTimeLoopQOTFilter::Execute(void)
{
    //
...
// ****************************************************************************
//  Method: avtTimeLoopQOTFilter::FilterSupportsTimeParallelization
//
//  Purpose:
...
bool
avtTimeLoopQOTFilter::FilterSupportsTimeParallelization(void)
{
    QueryAttributes qatts = atts.GetQueryAtts();
    qatts.SetTimeStep(currentTime);
    avtDataObjectQuery *query = avtQueryFactory::Instance()->
...
// ****************************************************************************
//  Method: avtTimeLoopQOTFilter::UpdateDataObjectInfo
//
//  Purpose:
...
void
avtTimeLoopQOTFilter::UpdateDataObjectInfo(void)
{
...
// ****************************************************************************
//  Method: avtTimeLoopQOTFilter::CreateFinalOutput
//
//  Purpose:
...
void
avtTimeLoopQOTFilter::CreateFinalOutput()
{
    if (ParallelizingOverTime())
    {
        double *totalQRes;
...
avtDataTree_p
avtTimeLoopQOTFilter::CreateTree(const doubleVector &times,
