...
class EXPRESSION_API avtGlobalSumExpression : public avtGlobalConstantExpression
{
  public:
  ...
  protected:
    ...
    // with reductions. In the case of global_sum, the safe value is 0.0, which will
