...
=========================================================================*/
// .NAME vtkOpenGLRenderer2 - OpenGL renderer
// .SECTION Description
// vtkOpenGLRenderer2 is a concrete implementation of the abstract class
// vtkRenderer. vtkOpenGLRenderer2 interfaces to the OpenGL graphics library.

#ifndef __vtkOpenGLRenderer2_h
#define __vtkOpenGLRenderer2_h

#include "vtkRenderer.h"

class vtkOpenGLRenderer2LayerList; // Pimpl
class vtkShaderProgram2;

class VTK_RENDERING_EXPORT vtkOpenGLRenderer2 : public vtkRenderer
{
protected:
  int NumberOfLightsBound;

public:
  static vtkOpenGLRenderer2 *New();
  vtkTypeMacro(vtkOpenGLRenderer2,vtkRenderer);
...
protected:
  ...
  vtkOpenGLRenderer2LayerList *LayerList;
...
private:
  vtkOpenGLRenderer2(const vtkOpenGLRenderer2&);  // Not implemented.
  void operator=(const vtkOpenGLRenderer2&);  // Not implemented.
};
