/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItOpenGLTexture.cxx,v $
...
void vtkVisItOpenGLTexture::ReleaseGraphicsResources(vtkWindow *renWin)
{
...
// COMMENT THIS LINE OUT BECAUSE IT MAKES THE TEXTURE CLASS INCOMPATIBLE
// WITH vtkQtRenderWindow.
...
unsigned char *vtkVisItOpenGLTexture::ResampleToPowerOfTwo(int &xs, int &ys, unsigned char *dptr,
                                                      int bpp)
{
...
void vtkVisItOpenGLTexture::PrintSelf(ostream& os, vtkIndent indent)
{
