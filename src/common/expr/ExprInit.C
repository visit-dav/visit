...
static void InitState_0(State &s)
{
    ...
    SetShiftState(s,   5, Symbol::Get(257));
    SetShiftState(s,   6, Symbol::Get(258));
    SetShiftState(s,   7, Symbol::Get(259));
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s,  10, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
    SetShiftState(s,  15, Symbol::Get("Database"));
}
...
static void InitState_1(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s,  16, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s,  17, Symbol::Get('-'));
    SetShiftState(s,  18, Symbol::Get('('));
    SetShiftState(s,  19, Symbol::Get('<'));
    SetShiftState(s,  20, Symbol::Get('{'));
    SetShiftState(s,  21, Symbol::Get(257));
    SetShiftState(s,  22, Symbol::Get(258));
    SetShiftState(s,  23, Symbol::Get(259));
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s,  26, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
    SetShiftState(s,  31, Symbol::Get("Database"));
}

static void InitState_3(State &s)
{
    // shift transitions
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s,  35, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s,  37, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
static void InitState_4(State &s)
{
    ...
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
    SetShiftState(s,  53, Symbol::Get("Database"));
}

static void InitState_5(State &s)
{
    // shift transitions
    SetShiftState(s,  54, Symbol::Get('('));
...
{
    // reduce rule 15: Constant ==> Integer 
...
{
    // reduce rule 17: Constant ==> String 
...
static void InitState_10(State &s)
{
    ...
    SetShiftState(s,  57, Symbol::Get('-'));
    SetShiftState(s,  58, Symbol::Get('/'));
    SetShiftState(s,  59, Symbol::Get('^'));
    SetShiftState(s,  60, Symbol::Get('%'));
    SetShiftState(s,  61, Symbol::Get('['));
...
static void InitState_17(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s,  62, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_18(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s,  63, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_19(State &s)
{
    ...
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s,  64, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s,  65, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
static void InitState_20(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s,  66, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s,  68, Symbol::Get('+'));
    SetShiftState(s,  69, Symbol::Get('*'));
    SetShiftState(s,  70, Symbol::Get('-'));
    SetShiftState(s,  71, Symbol::Get('/'));
    SetShiftState(s,  72, Symbol::Get('^'));
    SetShiftState(s,  73, Symbol::Get('%'));
    SetShiftState(s,  74, Symbol::Get('['));
    SetShiftState(s,  75, Symbol::Get(')'));
}
...
{
    // shift transitions
    SetShiftState(s,  76, Symbol::Get('-'));
    SetShiftState(s,  77, Symbol::Get('('));
    SetShiftState(s,  78, Symbol::Get('<'));
    SetShiftState(s,  79, Symbol::Get('{'));
    SetShiftState(s,  80, Symbol::Get('#'));
    SetShiftState(s,  81, Symbol::Get(257));
    SetShiftState(s,  82, Symbol::Get(258));
    SetShiftState(s,  83, Symbol::Get(259));
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s,  86, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  89, Symbol::Get("ListElems"));
    SetShiftState(s,  90, Symbol::Get("ListElem"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
    SetShiftState(s,  93, Symbol::Get("Database"));
}
...
static void InitState_35(State &s)
{
    ...
    SetShiftState(s,  96, Symbol::Get("MultiSlash"));
    SetShiftState(s,  97, Symbol::Get("MachSpec"));
    SetShiftState(s,  98, Symbol::Get("TimeSpec"));
...
static void InitState_36(State &s)
{
    ...
    SetShiftState(s, 100, Symbol::Get(257));
}
...
static void InitState_39(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 102, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_40(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 103, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_41(State &s)
{
    ...
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s, 104, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s, 105, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
{
    // shift transitions
    SetShiftState(s, 107, Symbol::Get('('));
...
{
    // shift transitions
    SetShiftState(s, 108, Symbol::Get('+'));
    SetShiftState(s, 109, Symbol::Get('*'));
...
static void InitState_54(State &s)
{
    ...
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 122, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    SetShiftState(s, 124, Symbol::Get(259));
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 127, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 132, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_55(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s, 136, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
static void InitState_56(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s, 137, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
static void InitState_57(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s, 138, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
static void InitState_58(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s, 139, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
static void InitState_59(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s, 140, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
static void InitState_60(State &s)
{
    ...
    SetShiftState(s,   8, Symbol::Get(260));
    SetShiftState(s,   9, Symbol::Get(261));
    SetShiftState(s, 141, Symbol::Get("Expr"));
    SetShiftState(s,  11, Symbol::Get("Constant"));
    SetShiftState(s,  12, Symbol::Get("Vector"));
    SetShiftState(s,  13, Symbol::Get("Function"));
    SetShiftState(s,  14, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 142, Symbol::Get(258));
}
...
static void InitState_67(State &s)
{
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 148, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_68(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 149, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_69(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 150, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_70(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 151, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_71(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 152, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_72(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 153, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_73(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 154, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 155, Symbol::Get(258));
}
...
static void InitState_76(State &s)
{
    ...
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s, 156, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
...
static void InitState_77(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 157, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_78(State &s)
{
    ...
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s, 158, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s, 159, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
static void InitState_79(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 160, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_80(State &s)
{
    ...
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s, 161, Symbol::Get("ListElems"));
    SetShiftState(s,  90, Symbol::Get("ListElem"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
    SetShiftState(s,  93, Symbol::Get("Database"));
...
{
    // shift transitions
    SetShiftState(s, 162, Symbol::Get('('));
...
{
    // shift transitions
    SetShiftState(s, 163, Symbol::Get('+'));
    SetShiftState(s, 164, Symbol::Get('*'));
    SetShiftState(s, 165, Symbol::Get('-'));
    SetShiftState(s, 166, Symbol::Get('/'));
    SetShiftState(s, 167, Symbol::Get('^'));
    SetShiftState(s, 168, Symbol::Get('%'));
    SetShiftState(s, 169, Symbol::Get('['));
    SetShiftState(s, 170, Symbol::Get(':'));

    // reduce rule 24: ListElem ==> Expr 
...
{
    // reduce rule 23: ListElems ==> ListElem 
...
{
    // shift transitions
    SetShiftState(s, 173, Symbol::Get(257));
}
...
static void InitState_96(State &s)
{
    // shift transitions
    SetShiftState(s,  99, Symbol::Get('/'));
    SetShiftState(s, 174, Symbol::Get(257));
}
...
static void InitState_97(State &s)
{
    // shift transitions
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s, 175, Symbol::Get("TimeSpec"));
...
static void InitState_101(State &s)
{
    ...
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 178, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_103(State &s)
{
    ...
    SetShiftState(s,  73, Symbol::Get('%'));
    SetShiftState(s,  74, Symbol::Get('['));
    SetShiftState(s, 180, Symbol::Get(')'));
}
...
static void InitState_104(State &s)
{
    ...
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s, 181, Symbol::Get('>'));
    SetShiftState(s,  95, Symbol::Get('@'));
    SetShiftState(s,  96, Symbol::Get("MultiSlash"));
    SetShiftState(s,  97, Symbol::Get("MachSpec"));
    SetShiftState(s,  98, Symbol::Get("TimeSpec"));
...
{
    // shift transitions
    SetShiftState(s, 182, Symbol::Get(':'));
}
...
static void InitState_106(State &s)
{
    ...
    SetShiftState(s, 113, Symbol::Get('%'));
    SetShiftState(s, 114, Symbol::Get('['));
    SetShiftState(s, 183, Symbol::Get(','));
}
...
static void InitState_107(State &s)
{
    ...
    SetShiftState(s, 117, Symbol::Get('['));
    SetShiftState(s, 118, Symbol::Get('('));
    SetShiftState(s, 184, Symbol::Get(')'));
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 122, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 185, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_108(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 186, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_109(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 187, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_110(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 188, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_111(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 189, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_112(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 190, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_113(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 191, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 192, Symbol::Get(258));
}

static void InitState_115(State &s)
{
    // shift transitions
    SetShiftState(s, 193, Symbol::Get('-'));
    SetShiftState(s, 194, Symbol::Get('('));
    SetShiftState(s, 195, Symbol::Get('<'));
    SetShiftState(s, 196, Symbol::Get('{'));
    SetShiftState(s, 197, Symbol::Get(257));
    SetShiftState(s, 198, Symbol::Get(258));
    SetShiftState(s, 199, Symbol::Get(259));
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 202, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
    SetShiftState(s, 207, Symbol::Get("Database"));
}
...
static void InitState_116(State &s)
{
    ...
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 208, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    SetShiftState(s, 124, Symbol::Get(259));
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 209, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
...
static void InitState_117(State &s)
{
    ...
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s, 210, Symbol::Get("ListElems"));
    SetShiftState(s,  90, Symbol::Get("ListElem"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
    SetShiftState(s,  93, Symbol::Get("Database"));
...
static void InitState_118(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 211, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
{
    // reduce rule 27: Function ==> Identifier ( ) 
    ...
    SetReduceRule(s,  27, Symbol::Get('%'));
    SetReduceRule(s,  27, Symbol::Get('['));
    SetReduceRule(s,  27, Symbol::Get(256));
}
...
static void InitState_120(State &s)
{
    ...
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s, 212, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s, 213, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
static void InitState_121(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 214, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
static void InitState_122(State &s)
{
    ...
    SetShiftState(s, 216, Symbol::Get('='));
...
{
    // shift transitions
    SetShiftState(s, 217, Symbol::Get('+'));
    SetShiftState(s, 218, Symbol::Get('*'));
    SetShiftState(s, 219, Symbol::Get('-'));
    SetShiftState(s, 220, Symbol::Get('/'));
    SetShiftState(s, 221, Symbol::Get('^'));
    SetShiftState(s, 222, Symbol::Get('%'));
    SetShiftState(s, 223, Symbol::Get('['));

    // reduce rule 31: Arg ==> Expr 
...
static void InitState_145(State &s)
{
    ...
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 228, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_146(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 229, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 230, Symbol::Get(')'));
    SetShiftState(s, 225, Symbol::Get(','));
}
...
{
    // shift transitions
    SetShiftState(s, 231, Symbol::Get(']'));
}
...
static void InitState_157(State &s)
{
    ...
    SetShiftState(s,  73, Symbol::Get('%'));
    SetShiftState(s,  74, Symbol::Get('['));
    SetShiftState(s, 232, Symbol::Get(')'));
}
...
static void InitState_158(State &s)
{
    ...
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s, 233, Symbol::Get('>'));
    SetShiftState(s,  95, Symbol::Get('@'));
    SetShiftState(s,  96, Symbol::Get("MultiSlash"));
    SetShiftState(s,  97, Symbol::Get("MachSpec"));
    SetShiftState(s,  98, Symbol::Get("TimeSpec"));
...
{
    // shift transitions
    SetShiftState(s, 234, Symbol::Get(':'));
}
...
static void InitState_160(State &s)
{
    ...
    SetShiftState(s, 113, Symbol::Get('%'));
    SetShiftState(s, 114, Symbol::Get('['));
    SetShiftState(s, 235, Symbol::Get(','));
}

static void InitState_161(State &s)
{
    // shift transitions
    SetShiftState(s, 236, Symbol::Get(']'));
    SetShiftState(s, 172, Symbol::Get(','));
}
...
static void InitState_162(State &s)
{
    ...
    SetShiftState(s, 117, Symbol::Get('['));
    SetShiftState(s, 118, Symbol::Get('('));
    SetShiftState(s, 237, Symbol::Get(')'));
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 122, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 238, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_163(State &s)
{
    ...
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s, 239, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
...
static void InitState_164(State &s)
{
    ...
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s, 240, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
...
static void InitState_165(State &s)
{
    ...
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s, 241, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
...
static void InitState_167(State &s)
{
    ...
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s, 243, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 245, Symbol::Get(258));
}
...
static void InitState_170(State &s)
{
    ...
    SetShiftState(s,  84, Symbol::Get(260));
    SetShiftState(s,  85, Symbol::Get(261));
    SetShiftState(s, 246, Symbol::Get("Expr"));
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 247, Symbol::Get(257));
...
static void InitState_172(State &s)
{
    ...
    SetShiftState(s,  87, Symbol::Get("Constant"));
    SetShiftState(s,  88, Symbol::Get("Vector"));
    SetShiftState(s, 248, Symbol::Get("ListElem"));
    SetShiftState(s,  91, Symbol::Get("Function"));
    SetShiftState(s,  92, Symbol::Get("Variable"));
    SetShiftState(s,  93, Symbol::Get("Database"));
}
...
static void InitState_178(State &s)
{
    ...
    SetShiftState(s, 250, Symbol::Get("MultiSlash"));
}
...
static void InitState_179(State &s)
{
    // shift transitions
    SetShiftState(s,  99, Symbol::Get('/'));
    SetShiftState(s, 251, Symbol::Get(257));
}
...
static void InitState_182(State &s)
{
    ...
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 253, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_183(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 254, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
static void InitState_193(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 257, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
static void InitState_194(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 258, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_195(State &s)
{
    ...
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s, 259, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s, 260, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
static void InitState_196(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 261, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 262, Symbol::Get('('));
...
static void InitState_202(State &s)
{
    ...
    SetShiftState(s, 267, Symbol::Get('^'));
    SetShiftState(s, 268, Symbol::Get('%'));
...
{
    // shift transitions
    SetShiftState(s, 272, Symbol::Get(']'));
    SetShiftState(s, 172, Symbol::Get(','));
}
...
static void InitState_212(State &s)
{
    ...
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s, 274, Symbol::Get('>'));
    SetShiftState(s,  95, Symbol::Get('@'));
    SetShiftState(s,  96, Symbol::Get("MultiSlash"));
    SetShiftState(s,  97, Symbol::Get("MachSpec"));
    SetShiftState(s,  98, Symbol::Get("TimeSpec"));
...
{
    // shift transitions
    SetShiftState(s, 275, Symbol::Get(':'));
}
...
static void InitState_215(State &s)
{
    ...
    SetShiftState(s, 117, Symbol::Get('['));
    SetShiftState(s, 118, Symbol::Get('('));
    SetShiftState(s, 277, Symbol::Get(')'));
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 122, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 278, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_216(State &s)
{
    ...
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 279, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
...
static void InitState_217(State &s)
{
    ...
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 280, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
...
static void InitState_219(State &s)
{
    ...
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 282, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
...
static void InitState_221(State &s)
{
    ...
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 284, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
...
static void InitState_222(State &s)
{
    ...
    SetShiftState(s, 125, Symbol::Get(260));
    SetShiftState(s, 126, Symbol::Get(261));
    SetShiftState(s, 285, Symbol::Get("Expr"));
    SetShiftState(s, 128, Symbol::Get("Constant"));
    SetShiftState(s, 129, Symbol::Get("Vector"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 286, Symbol::Get(258));
}

static void InitState_224(State &s)
{
    // reduce rule 28: Function ==> Identifier ( Args ) 
...
static void InitState_225(State &s)
{
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 287, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_234(State &s)
{
    ...
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 292, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_235(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 293, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
static void InitState_246(State &s)
{
    ...
    // reduce rule 25: ListElem ==> Expr : Expr 
...
{
    // reduce rule 22: ListElems ==> ListElems , ListElem 
...
static void InitState_250(State &s)
{
    // shift transitions
    SetShiftState(s,  99, Symbol::Get('/'));
    SetShiftState(s, 297, Symbol::Get(257));
}
...
{
    // shift transitions
    SetShiftState(s, 303, Symbol::Get(':'));
}
...
static void InitState_261(State &s)
{
    ...
    SetShiftState(s, 113, Symbol::Get('%'));
    SetShiftState(s, 114, Symbol::Get('['));
    SetShiftState(s, 304, Symbol::Get(','));
}
...
static void InitState_262(State &s)
{
    ...
    SetShiftState(s, 117, Symbol::Get('['));
    SetShiftState(s, 118, Symbol::Get('('));
    SetShiftState(s, 305, Symbol::Get(')'));
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 122, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 306, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_267(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 311, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
static void InitState_268(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 312, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 313, Symbol::Get(258));
}

static void InitState_270(State &s)
{
    // reduce rule 19: Vector ==> { Expr , Expr } 
...
static void InitState_271(State &s)
{
    ...
    SetShiftState(s, 318, Symbol::Get(257));
    SetShiftState(s, 319, Symbol::Get(258));
    SetShiftState(s, 320, Symbol::Get(259));
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 323, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
    SetShiftState(s, 328, Symbol::Get("Database"));
}

static void InitState_272(State &s)
{
    // reduce rule 21: List ==> [ ListElems ] 
...
static void InitState_275(State &s)
{
    // shift transitions
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s, 329, Symbol::Get('>'));
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 330, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_276(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 331, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 332, Symbol::Get(')'));
    SetShiftState(s, 225, Symbol::Get(','));
}
...
static void InitState_279(State &s)
{
    ...
    // reduce rule 32: Arg ==> Identifier = Expr 
...
static void InitState_290(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 334, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_293(State &s)
{
    ...
    SetShiftState(s, 268, Symbol::Get('%'));
    SetShiftState(s, 269, Symbol::Get('['));
    SetShiftState(s, 336, Symbol::Get('}'));
...
static void InitState_296(State &s)
{
    ...
    SetShiftState(s, 342, Symbol::Get(257));
    SetShiftState(s, 343, Symbol::Get(258));
    SetShiftState(s, 344, Symbol::Get(259));
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 347, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
    SetShiftState(s, 352, Symbol::Get("Database"));
}
...
static void InitState_300(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 353, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_303(State &s)
{
    ...
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 355, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_304(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 356, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
static void InitState_314(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 359, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_315(State &s)
{
    ...
    SetShiftState(s,  24, Symbol::Get(260));
    SetShiftState(s,  25, Symbol::Get(261));
    SetShiftState(s, 360, Symbol::Get("Expr"));
    SetShiftState(s,  27, Symbol::Get("Constant"));
    SetShiftState(s,  28, Symbol::Get("Vector"));
    SetShiftState(s,  29, Symbol::Get("Function"));
    SetShiftState(s,  30, Symbol::Get("Variable"));
...
static void InitState_316(State &s)
{
    ...
    SetShiftState(s,  33, Symbol::Get('['));
    SetShiftState(s,  34, Symbol::Get(257));
    SetShiftState(s, 361, Symbol::Get("PathSpec"));
    SetShiftState(s,  36, Symbol::Get("MultiSlash"));
    SetShiftState(s, 362, Symbol::Get("DBSpec"));
    SetShiftState(s,  38, Symbol::Get("TimeSpec"));
}
...
static void InitState_317(State &s)
{
    ...
    SetShiftState(s,  46, Symbol::Get(260));
    SetShiftState(s,  47, Symbol::Get(261));
    SetShiftState(s, 363, Symbol::Get("Expr"));
    SetShiftState(s,  49, Symbol::Get("Constant"));
    SetShiftState(s,  50, Symbol::Get("Vector"));
    SetShiftState(s,  51, Symbol::Get("Function"));
    SetShiftState(s,  52, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 364, Symbol::Get('('));
...
{
    // shift transitions
    SetShiftState(s, 365, Symbol::Get('+'));
    SetShiftState(s, 366, Symbol::Get('*'));
    SetShiftState(s, 367, Symbol::Get('-'));
    SetShiftState(s, 368, Symbol::Get('/'));
    SetShiftState(s, 369, Symbol::Get('^'));
    SetShiftState(s, 370, Symbol::Get('%'));
    SetShiftState(s, 371, Symbol::Get('['));
    SetShiftState(s, 372, Symbol::Get('}'));
}
...
static void InitState_330(State &s)
{
    // shift transitions
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s, 373, Symbol::Get('>'));
    SetShiftState(s, 250, Symbol::Get("MultiSlash"));
}
...
static void InitState_334(State &s)
{
    ...
    SetShiftState(s, 370, Symbol::Get('%'));
    SetShiftState(s, 371, Symbol::Get('['));
    SetShiftState(s, 376, Symbol::Get('}'));
}
...
static void InitState_338(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 378, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
static void InitState_347(State &s)
{
    ...
    // reduce rule 26: ListElem ==> Expr : Expr : Expr 
...
static void InitState_353(State &s)
{
    ...
    SetShiftState(s, 370, Symbol::Get('%'));
    SetShiftState(s, 371, Symbol::Get('['));
    SetShiftState(s, 391, Symbol::Get('}'));
}
...
static void InitState_355(State &s)
{
    // shift transitions
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s, 392, Symbol::Get('>'));
    SetShiftState(s, 250, Symbol::Get("MultiSlash"));
}
...
static void InitState_356(State &s)
{
    ...
    SetShiftState(s, 394, Symbol::Get(','));
}
...
static void InitState_360(State &s)
{
    ...
    SetShiftState(s,  73, Symbol::Get('%'));
    SetShiftState(s,  74, Symbol::Get('['));
    SetShiftState(s, 395, Symbol::Get(')'));
}
...
static void InitState_363(State &s)
{
    ...
    SetShiftState(s, 113, Symbol::Get('%'));
    SetShiftState(s, 114, Symbol::Get('['));
    SetShiftState(s, 398, Symbol::Get(','));
}
...
static void InitState_364(State &s)
{
    ...
    SetShiftState(s, 117, Symbol::Get('['));
    SetShiftState(s, 118, Symbol::Get('('));
    SetShiftState(s, 399, Symbol::Get(')'));
    SetShiftState(s, 120, Symbol::Get('<'));
    SetShiftState(s, 121, Symbol::Get('{'));
    SetShiftState(s, 122, Symbol::Get(257));
    SetShiftState(s, 123, Symbol::Get(258));
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 400, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_365(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 401, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_366(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 402, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_368(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 404, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_369(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 405, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_370(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 406, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 407, Symbol::Get(258));
}

static void InitState_372(State &s)
{
    // reduce rule 20: Vector ==> { Expr , Expr , Expr } 
...
static void InitState_375(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 408, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_383(State &s)
{
    ...
    SetShiftState(s, 130, Symbol::Get("List"));
    SetShiftState(s, 131, Symbol::Get("Function"));
    SetShiftState(s, 415, Symbol::Get("Args"));
    SetShiftState(s, 133, Symbol::Get("Arg"));
    SetShiftState(s, 134, Symbol::Get("Variable"));
    SetShiftState(s, 135, Symbol::Get("Database"));
}
...
static void InitState_384(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 416, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
static void InitState_385(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 417, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
static void InitState_386(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 418, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
static void InitState_387(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 419, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
static void InitState_388(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 420, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
static void InitState_389(State &s)
{
    ...
    SetShiftState(s, 345, Symbol::Get(260));
    SetShiftState(s, 346, Symbol::Get(261));
    SetShiftState(s, 421, Symbol::Get("Expr"));
    SetShiftState(s, 348, Symbol::Get("Constant"));
    SetShiftState(s, 349, Symbol::Get("Vector"));
    SetShiftState(s, 350, Symbol::Get("Function"));
    SetShiftState(s, 351, Symbol::Get("Variable"));
...
{
    // shift transitions
    SetShiftState(s, 422, Symbol::Get(258));
}
...
static void InitState_394(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 423, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_397(State &s)
{
    // shift transitions
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s, 424, Symbol::Get('>'));
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 425, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
{
    // shift transitions
    SetShiftState(s, 427, Symbol::Get(')'));
    SetShiftState(s, 225, Symbol::Get(','));
}
...
{
    // shift transitions
    SetShiftState(s, 428, Symbol::Get(']'));
}
...
static void InitState_408(State &s)
{
    ...
    SetShiftState(s, 370, Symbol::Get('%'));
    SetShiftState(s, 371, Symbol::Get('['));
    SetShiftState(s, 429, Symbol::Get('}'));
}
...
static void InitState_412(State &s)
{
    // shift transitions
    SetShiftState(s,  32, Symbol::Get('/'));
    SetShiftState(s, 430, Symbol::Get('>'));
    SetShiftState(s, 177, Symbol::Get(257));
    SetShiftState(s, 431, Symbol::Get("PathSpec"));
    SetShiftState(s, 179, Symbol::Get("MultiSlash"));
}
...
static void InitState_413(State &s)
{
    ...
    SetShiftState(s, 200, Symbol::Get(260));
    SetShiftState(s, 201, Symbol::Get(261));
    SetShiftState(s, 432, Symbol::Get("Expr"));
    SetShiftState(s, 203, Symbol::Get("Constant"));
    SetShiftState(s, 204, Symbol::Get("Vector"));
    SetShiftState(s, 205, Symbol::Get("Function"));
    SetShiftState(s, 206, Symbol::Get("Variable"));
...
static void InitState_438(State &s)
{
    ...
    SetShiftState(s, 321, Symbol::Get(260));
    SetShiftState(s, 322, Symbol::Get(261));
    SetShiftState(s, 442, Symbol::Get("Expr"));
    SetShiftState(s, 324, Symbol::Get("Constant"));
    SetShiftState(s, 325, Symbol::Get("Vector"));
    SetShiftState(s, 326, Symbol::Get("Function"));
    SetShiftState(s, 327, Symbol::Get("Variable"));
...
static void InitState_442(State &s)
{
    ...
    SetShiftState(s, 370, Symbol::Get('%'));
    SetShiftState(s, 371, Symbol::Get('['));
    SetShiftState(s, 444, Symbol::Get('}'));
}
...
static void InitState_443(State &s)
{
    ...
    SetShiftState(s, 370, Symbol::Get('%'));
    SetShiftState(s, 371, Symbol::Get('['));
    SetShiftState(s, 445, Symbol::Get('}'));
}
