...
PickAttributes::PickAttributes() : AttributeSubject("bbsiiiissFFi*s*a*bbs*FFbis")
{
    clearWindow = false;
    fulfilled = false;
    elementNumber = -1;
...
PickAttributes::PickAttributes(const PickAttributes &obj) : AttributeSubject("bbsiiiissFFi*s*a*bbs*FFbis")
{
