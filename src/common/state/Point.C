...
{
    return ValueType_strings[(int)t];
}

std::string
Point::ValueType_ToString(int t)
{
    return ValueType_strings[t];
}
...
Point::Point() : AttributeSubject("s")
{
}
...
Point::Point(const Point &obj) : AttributeSubject("s")
{
    value = obj.value;
...
bool
Point::CreateNode(DataNode *parentNode, bool forceAdd)
{
    if(parentNode == 0)
        return false;
