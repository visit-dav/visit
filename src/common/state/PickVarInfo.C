...
PickVarInfo::PickVarInfo() : AttributeSubject("sss*d*s*d*bisbi*")
{
    mixVar = false;
    centering = None;
    varIsMaterial = false;
...
PickVarInfo::PickVarInfo(const PickVarInfo &obj) : AttributeSubject("sss*d*s*d*bisbi*")
{
...
PickVarInfo::SelectAll()
{
    ...
    Select(9, (void *)&varIsMaterial);
    Select(10, (void *)&numMatsPerZone);
}
...
PickVarInfo::GetFieldName(int index) const
{
    switch (index)
    {
        ...
        case 9:  return "varIsMaterial";
        case 10:  return "numMatsPerZone";
