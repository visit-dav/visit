...
//
// Programmer: xml2atts
// Creation:   Fri Aug 15 08:33:48 PDT 2003
//
// Modifications:
//   
// ****************************************************************************

View2DAttributes::View2DAttributes() : AttributeSubject("DD")
{
    windowCoords[0] = 0;
    windowCoords[1] = 0;
    windowCoords[2] = 1;
...
View2DAttributes::View2DAttributes(const View2DAttributes &obj) : AttributeSubject("DD")
{
    int i;
...
bool
View2DAttributes::CreateNode(DataNode *parentNode, bool forceAdd)
{
    if(parentNode == 0)
        return false;
