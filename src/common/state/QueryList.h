...
//
// Programmer: xml2atts
// Creation:   Tue Dec 2 08:23:57 PDT 2003
//
// Modifications:
//   
// ****************************************************************************
...
public:
    ...
    void SetCurrentPlot(const intVector &currentPlot_);
    ...
    const intVector    &GetCurrentPlot() const;
          intVector    &GetCurrentPlot();
...
public:
    ...
    int CurrentPlotOnly(const std::string &name);
