...
public:
    ...
    void SetTimeQuery(const intVector &timeQuery_);
    ...
    const intVector    &GetTimeQuery() const;
          intVector    &GetTimeQuery();
...
public:
    ...
    void AddQuery(const std::string &name, QueryType t, Groups g, CoordinateRepresentation r, WindowType w, int num_input, int allowedVars, bool timeQ);
