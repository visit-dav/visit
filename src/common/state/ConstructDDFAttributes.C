...
"Median", "InterquartileRange", "Mode", 
"Sum"};
...
ConstructDDFAttributes::ConstructDDFAttributes() : AttributeSubject("ss*d*siddii*")
{
...
ConstructDDFAttributes::ConstructDDFAttributes(const ConstructDDFAttributes &obj) : AttributeSubject("ss*d*siddii*")
{
    ddfName = obj.ddfName;
