...
public class QueryAttributes extends AttributeSubject
{
    ...
    public QueryAttributes()
    {
        ...
        compressedResultsValue = new Vector();
    }
    ...
    public QueryAttributes(QueryAttributes obj)
    {
        ...
        compressedResultsValue = new Vector(obj.compressedResultsValue.size());
        for(i = 0; i < obj.compressedResultsValue.size(); ++i)
        {
            Byte bv = (Byte)obj.compressedResultsValue.elementAt(i);
            compressedResultsValue.addElement(new Byte(bv.byteValue()));
        }
    ...
    public boolean equals(QueryAttributes obj)
    {
        ...
        // Compare the elements in the compressedResultsValue vector.
        boolean compressedResultsValue_equal = (obj.compressedResultsValue.size() == compressedResultsValue.size());
        for(i = 0; (i < compressedResultsValue.size()) && compressedResultsValue_equal; ++i)
        {
            // Make references to Byte from Object.
            Byte compressedResultsValue1 = (Byte)compressedResultsValue.elementAt(i);
            Byte compressedResultsValue2 = (Byte)obj.compressedResultsValue.elementAt(i);
            compressedResultsValue_equal = compressedResultsValue1.equals(compressedResultsValue2);
        }
    ...
    public void SetCompressedResultsValue(Vector compressedResultsValue_)
    {
    ...
    public Vector  GetCompressedResultsValue() { return compressedResultsValue; }
    ...
    public void WriteAtts(CommunicationBuffer buf)
    {
        ...
        if(WriteSelect(13, buf))
            buf.WriteByteVector(compressedResultsValue);
    }
    ...
    public void ReadAtts(int index, CommunicationBuffer buf)
    {
        ...
        case 12:
            ...
            break;
        case 13:
            SetCompressedResultsValue(buf.ReadByteVector());
            break;
        }
    }
    ...
    public String toString(String indent)
    {
        ...
        str = str + ucharVectorToString("compressedResultsValue", compressedResultsValue, indent) + "\n";
        return str;
    }
    ...
    private Vector  compressedResultsValue; // vector of Byte objects
}
