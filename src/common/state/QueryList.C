...
//
// Programmer: xml2atts
// Creation:   Thu Oct 2 14:18:13 PST 2003
//
// Modifications:
//   
// ****************************************************************************

QueryList::QueryList() : AttributeSubject("s*i*i*i*")
{
}
...
QueryList::QueryList(const QueryList &obj) : AttributeSubject("s*i*i*i*")
{
    names = obj.names;
    types = obj.types;
...
QueryList::AddQuery(const std::string &name, QueryList::QueryType t,
    QueryList::CoordinateRepresentation rep, int number_input)
{
