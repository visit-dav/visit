...
ColorControlPointList::ColorControlPointList() : AttributeSubject("a*bbb")
{
    smoothingFlag = true;
...
ColorControlPointList::ColorControlPointList(const ColorControlPointList &obj) : AttributeSubject("a*bbb")
{
