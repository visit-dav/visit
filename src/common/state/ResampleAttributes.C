...
//
// Programmer: xml2atts
// Creation:   Wed Oct 1 14:54:39 PST 2003
//
// Modifications:
//   
// ****************************************************************************

ResampleAttributes::ResampleAttributes() : AttributeSubject("biiiibf")
{
    useTargetVal = false;
    targetVal = 100000;
    width = 30;
...
ResampleAttributes::ResampleAttributes(const ResampleAttributes &obj) : AttributeSubject("biiiibf")
{
