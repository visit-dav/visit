...
InteractorAttributes::InteractorAttributes() : AttributeSubject("bbi")
{
    showGuidelines = true;
    clampSquare = false;
...
InteractorAttributes::InteractorAttributes(const InteractorAttributes &obj) : AttributeSubject("bbi")
{
