...
QueryAttributes::QueryAttributes() : AttributeSubject("ss*sDiid*iii*iibss")
{
...
QueryAttributes::QueryAttributes(const QueryAttributes &obj) : AttributeSubject("ss*sDiid*iii*iibss")
{
    name = obj.name;
