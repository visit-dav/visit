...
//
// Programmer: xml2atts
// Creation:   Thu Sep 15 15:41:43 PST 2005
//
// Modifications:
//   
// ****************************************************************************

HostProfile::HostProfile() : AttributeSubject("sssiibibsbsbsbsbbbs*bbssbbiisbsb")
{
    profileName = "notset";
    host = "localhost";
...
HostProfile::HostProfile(const HostProfile &obj) : AttributeSubject("sssiibibsbsbsbsbbbs*bbssbbiisbsb")
{
