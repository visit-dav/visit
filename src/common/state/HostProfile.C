...
//
// Programmer: xml2atts
// Creation:   Wed Jul 23 11:30:22 PDT 2003
//
// Modifications:
//   
// ****************************************************************************

HostProfile::HostProfile() : AttributeSubject("sssiibibsbsbsbsbbbs*bbssb")
{
    profileName = "notset";
    host = "localhost";
...
HostProfile::HostProfile(const HostProfile &obj) : AttributeSubject("sssiibibsbsbsbsbbbs*bbssb")
{
