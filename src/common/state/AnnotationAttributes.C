...
{
    return Ticks_strings[(int)t];
}

std::string
AnnotationAttributes::Ticks_ToString(int t)
{
    return Ticks_strings[t];
}
...
{
    return Location_strings[(int)t];
}

std::string
AnnotationAttributes::Location_ToString(int t)
{
    return Location_strings[t];
}
...
{
    return Axes_strings[(int)t];
}

std::string
AnnotationAttributes::Axes_ToString(int t)
{
    return Axes_strings[t];
}
...
{
    return GradientStyle_strings[(int)t];
}

std::string
AnnotationAttributes::GradientStyle_ToString(int t)
{
    return GradientStyle_strings[t];
}
...
{
    return BackgroundMode_strings[(int)t];
}

std::string
AnnotationAttributes::BackgroundMode_ToString(int t)
{
    return BackgroundMode_strings[t];
}
...
AnnotationAttributes::SetFromNode(DataNode *parentNode)
{
    ...
    if((node = searchNode->GetNode("axesTickLocation2D")) != 0)
    {
        ...
        if(node->GetNodeType() == INT_NODE)
            SetAxesTickLocation2D(Location(node->AsInt()));
    ...
    if((node = searchNode->GetNode("axesTicks2D")) != 0)
    {
        // Allow enums to be int or string in the config file
        if(node->GetNodeType() == INT_NODE)
            SetAxesTicks2D(Ticks(node->AsInt()));
        else if(node->GetNodeType() == STRING_NODE)
        {
            Ticks value;
    ...
    if((node = searchNode->GetNode("axesTickLocation")) != 0)
    {
        // Allow enums to be int or string in the config file
        if(node->GetNodeType() == INT_NODE)
            SetAxesTickLocation(Location(node->AsInt()));
        else if(node->GetNodeType() == STRING_NODE)
        {
            Location value;
            if(Location_FromString(node->AsString(), value))
    ...
    if((node = searchNode->GetNode("gradientBackgroundStyle")) != 0)
    {
        // Allow enums to be int or string in the config file
        if(node->GetNodeType() == INT_NODE)
            SetGradientBackgroundStyle(GradientStyle(node->AsInt()));
        else if(node->GetNodeType() == STRING_NODE)
        {
            GradientStyle value;
    ...
    if((node = searchNode->GetNode("backgroundMode")) != 0)
    {
        // Allow enums to be int or string in the config file
        if(node->GetNodeType() == INT_NODE)
            SetBackgroundMode(BackgroundMode(node->AsInt()));
        else if(node->GetNodeType() == STRING_NODE)
        {
