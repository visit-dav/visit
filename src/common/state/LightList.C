...
bool
LightList::CreateNode(DataNode *parentNode, bool forceAdd)
{
    if(parentNode == 0)
        return false;
    ...
    if(!FieldsEqual(0, &defaultObject))
    {
        ...
        if(light0.CreateNode(light0Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(1, &defaultObject))
    {
        ...
        if(light1.CreateNode(light1Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(2, &defaultObject))
    {
        ...
        if(light2.CreateNode(light2Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(3, &defaultObject))
    {
        ...
        if(light3.CreateNode(light3Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(4, &defaultObject))
    {
        ...
        if(light4.CreateNode(light4Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(5, &defaultObject))
    {
        ...
        if(light5.CreateNode(light5Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(6, &defaultObject))
    {
        ...
        if(light6.CreateNode(light6Node, false))
        {
            addToParent = true;
    ...
    if(!FieldsEqual(7, &defaultObject))
    {
        ...
        if(light7.CreateNode(light7Node, false))
        {
            addToParent = true;
