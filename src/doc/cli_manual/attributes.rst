...
|
    ...
    | axes2D.lineWidth                                 | 0                          |
    +--------------------------------------------------+----------------------------+
    | axes2D.tickLocation                              | Inside, Outside, Both      |
    +--------------------------------------------------+----------------------------+
    ...
    +--------------------------------------------------+----------------------------+
    | axes2D.xAxis.title.font.font                     | Arial, Courier, Times      |
    +--------------------------------------------------+----------------------------+
    ...
    +--------------------------------------------------+----------------------------+
    | axes2D.xAxis.label.font.font                     | Arial, Courier, Times      |
    +--------------------------------------------------+----------------------------+
    ...
    +--------------------------------------------------+----------------------------+
    | axes2D.yAxis.title.font.font                     | Arial, Courier, Times      |
    +--------------------------------------------------+----------------------------+
    ...
    +--------------------------------------------------+----------------------------+
    | axes2D.yAxis.label.font.font                     | Arial, Courier, Times      |
    +--------------------------------------------------+----------------------------+
    ...
    +--------------------------------------------------+----------------------------+
    | databaseInfoExpansionMode                        |  File, Directory, Full,    |
...
|
    ...
    | planeInverse                     | 0                          |
    +----------------------------------+----------------------------+
    | planeToolControlledClipPlane     |  None, Plane1, Plane2,     |
    |                                  |  Plane3                    |
    +----------------------------------+----------------------------+
    | center                           | (0, 0, 0)                  |
    +----------------------------------+----------------------------+
...
|
    ...
    | normal             | (0, 0, 1)                  |
    +--------------------+----------------------------+
    | representation     |  ThreeD, Flattened,        |
    |                    |  R_Theta                   |
    +--------------------+----------------------------+
    | upAxis             | (0, 1, 0)                  |
    +--------------------+----------------------------+
...
|
    ...
    +---------------+----------------------------+
    | newCoord2     | Coord1, Coord2, Coord3     |
    +---------------+----------------------------+
    | newCoord3     | Coord1, Coord2, Coord3     |
    +---------------+----------------------------+
...
|
    ...
    +--------------------------------------+----------------------------+
    | precisionType                        | Float, Native, Double      |
    +--------------------------------------+----------------------------+
...
|
    ...
    +------------------------+----------------------------+
    | histogramType          |  Frequency, Weighted,      |
    |                        |  Variable                  |
    +------------------------+----------------------------+
...
|
    ...
    | pathlinesPeriod                        | 0                           |
    +----------------------------------------+-----------------------------+
    | pathlinesCMFE                          | CONN_CMFE, POS_CMFE         |
    +----------------------------------------+-----------------------------+
...
|
    ...
    | numSteps        | 1000                       |
    +-----------------+----------------------------+
    | XAxisSample     |  Step, Time, ArcLength,    |
    |                 |  Speed, Vorticity,         |
    |                 |  Variable                  |
    +-----------------+----------------------------+
    | YAxisSample     |  Step, Time, ArcLength,    |
    |                 |  Speed, Vorticity,         |
    |                 |  Variable                  |
    +-----------------+----------------------------+
    | variable        | "default"                  |
...
|
    ...
    +------------------------------+----------------------------+
    | discretizationMode           |  Uniform, Adaptive,        |
    |                              |  MultiPass                 |
    +------------------------------+----------------------------+
...
|
    ...
    | **Attribute**                 | **Default/Allowed Values** |
    +-------------------------------+----------------------------+
    | drawAtomsAs                   |  NoAtoms, SphereAtoms,     |
    |                               |  ImposterAtoms             |
    +-------------------------------+----------------------------+
...
|
    ...
    +---------------------------------------+-----------------------------+
    | puncturePlane                         |  Poloidal, Toroidal,        |
    |                                       |  Arbitrary                  |
    +---------------------------------------+-----------------------------+
    | sourceType                            |  SpecifiedPoint,            |
    |                                       |  PointList,                 |
...
|
    ...
    +----------------------------------+----------------------------+
    | geometryRepresentation           |  Surfaces, Wireframe,      |
    |                                  |  Points                    |
    +----------------------------------+----------------------------+
    | stereoRendering                  | 0                          |
    +----------------------------------+----------------------------+
    | stereoType                       |  RedBlue, Interlaced,      |
    |                                  |  CrystalEyes, RedGreen     |
    +----------------------------------+----------------------------+
    | notifyForEachRender              | 0                          |
    +----------------------------------+----------------------------+
    | scalableActivationMode           | Never, Always, Auto        |
    +----------------------------------+----------------------------+
...
|
    ...
    | stereo                               | 0                          |
    +--------------------------------------+----------------------------+
    | compression                          |  None, PackBits, Jpeg,     |
    |                                      |  Deflate, LZW              |
    +--------------------------------------+----------------------------+
    | forceMerge                           | 0                          |
    +--------------------------------------+----------------------------+
...
|
    ...
    +--------------------+----------------------------+
    | statisticType      |  Sum, Mean, Variance,      |
    |                    |  StandardDeviation,        |
    |                    |  Slope, Residuals          |
    +--------------------+----------------------------+
...
|
    ...
    | samplesPerRay                                       | 500                          |
    +-----------------------------------------------------+------------------------------+
    | rendererType                                        |  Default, RayCasting,        |
    ...
    | rendererSamples                                     | 3                            |
    +-----------------------------------------------------+------------------------------+
    | lowGradientLightingReduction                        |  Off, Lowest, Lower,         |
    |                                                     |  Low, Medium, High,          |
    |                                                     |  Higher, Highest             |
    +-----------------------------------------------------+------------------------------+
