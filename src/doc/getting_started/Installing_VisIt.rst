...
.. warning::
    ...
    Thereafter, VisIt_ should start up farily quickly (< 10 seconds).
    Depending on the platform, the delays may involve some computational load and network traffic as a variety of integrety checks are performed.
