...
.. warning::
    ...
    Depending on the platform, the delays may involve some computational effort and network latency as a variety of integrety checks are performed on all of VisIt_'s libraries and plugins.
