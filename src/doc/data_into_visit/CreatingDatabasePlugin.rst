...
Rectilinear meshes are specified by lists of coordinate values for each axis.
...
More information on these cell types and more can be found in `VTK's Cell types docs <https://examples.vtk.org/site/VTKBook/05Chapter5/#54-cell-types>`_.
...
There is logic in VisIt_ to automatically recognize these scalar variable naming patterns and define VisIt_ *expressions* for the appropriate aggregate mesh variable types.
