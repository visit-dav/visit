...
In general, the **Refinement Basis** applies to all high order data from these plugins.
...
*LOR* is short for *Low Order Refinement*.
...
The **Grid Function Projection Method** only applies to grid functions from the Blueprint and MFEM plugins.
