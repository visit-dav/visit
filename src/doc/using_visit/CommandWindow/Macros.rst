...
.. warning::
    ...
    In particular, operations involving interaction with the filesystem such as changing the current working directory and creating a directory (or folder) are not recorded.
