...
You can export data transfomed by VisIt pipelines to be reopend in VisIt, or to be used in other tools. 
...
Exporting to CSV
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
You can also flatten your mesh and fields into vertex and cell tables and save those to CSV files.
While exporting to CSV discards mesh topology info, this provide a simple, easy to parse format, that many tools can read. 
