...
**ConnCompReduce**: *ConnCompReduceAttributes()*
------------------------------------------------
...
**ExtrudeStacked**: *ExtrudeStackedAttributes()*
------------------------------------------------
...
**MetricThreshold**: *MetricThresholdAttributes()*
--------------------------------------------------
...
**RemoveCells**: *RemoveCellsAttributes()*
------------------------------------------
...
--------------------------------------
    ...
    | **Attribute**                               | **Default**/Allowed Values |
    +---------------------------------------------+----------------------------+
    | antialiasing                                | **NONE**, MSAA, FXAA       |
    +---------------------------------------------+----------------------------+
    | MSAASamples                                 | 4                          |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.relativeContrastThreshold           |  **HighQuality**,          |
    |                                             |  TooLittle,                |
    |                                             |  LowQuality, Overkill,     |
    |                                             |  CustomRCT                 |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.customRCT                           | 0.125                      |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.hardContrastThreshold               |  **HigherQuality**,        |
    |                                             |  VisibleLimit,             |
    |                                             |  UpperLimit, CustomHCT     |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.customHCT                           | 0.0625                     |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.subpixelBlendLimit                  |  **MediumBlending**,       |
    |                                             |  LowBlending,              |
    |                                             |  HighBlending,             |
    |                                             |  MaximumBlending,          |
    |                                             |  CustomBlending            |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.customSBL                           | 0.75                       |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.subpixelContrastThreshold           |  **DefaultRemoval**,       |
    |                                             |  LowRemoval,               |
    |                                             |  MediumRemoval,            |
    |                                             |  HighRemoval,              |
    |                                             |  CompleteRemoval,          |
    |                                             |  CustomRemoval             |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.customSCT                           | 0.25                       |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.useHighQualityEndpoints             | 1                          |
    +---------------------------------------------+----------------------------+
    | FXAAOpt.endpointSearchIterations            | 12                         |
    +---------------------------------------------+----------------------------+
    | orderComposite                              | 1                          |
    +---------------------------------------------+----------------------------+
    ...
    | osprayShadows                               | 0                          |
    +---------------------------------------------+----------------------------+
    | anariAttributes.anariRendering              | 0                          |
    +---------------------------------------------+----------------------------+
    | anariAttributes.anariLibrary                | ""                         |
    +---------------------------------------------+----------------------------+
    | anariAttributes.anariLibrarySubtype         | "default"                  |
    +---------------------------------------------+----------------------------+
    | anariAttributes.anariRendererSubtype        | "default"                  |
    +---------------------------------------------+----------------------------+
    | anariAttributes.usingUsdDevice              | 0                          |
    +---------------------------------------------+----------------------------+
    | anariAttributes.anariRendererParameters     | ()                         |
    +---------------------------------------------+----------------------------+
    | anariAttributes.anariUSDParameters          | ()                         |
    +---------------------------------------------+----------------------------+
...
**SurfCompPrep**: *SurfCompPrepAttributes()*
--------------------------------------------

    +-----------------+----------------------------+
    | **Attribute**   | **Default**/Allowed Values |
    +-----------------+----------------------------+
    | surfaceType     |  **Average**, Closest,     |
    |                 |  Farthest                  |
    +-----------------+----------------------------+
