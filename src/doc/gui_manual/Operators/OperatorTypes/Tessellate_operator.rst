...
the Mesh plot. When the points are merged, the mesh lines of the individual
cells of the tessellation will be visible. When the points are not merged,
the lines of the high order element will typically only be visible.
