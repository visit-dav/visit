...
static PyObject *ConstructDataBinningAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PyConstructDataBinningAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(ConstructDataBinningAttributes);
