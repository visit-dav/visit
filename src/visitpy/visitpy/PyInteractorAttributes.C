...
static PyObject *InteractorAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PyInteractorAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(InteractorAttributes);
