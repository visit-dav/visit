...
static PyObject *SaveSubWindowsAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PySaveSubWindowsAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(SaveSubWindowsAttributes);
