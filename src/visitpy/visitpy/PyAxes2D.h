...
VISITPY_API PyObject *     PyAxes2D_getattro(PyObject *self, PyObject *attr_name);
int VISITPY_API            PyAxes2D_setattro(PyObject *self, PyObject *attr_name, PyObject *args);
