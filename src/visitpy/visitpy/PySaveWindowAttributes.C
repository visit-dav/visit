...
static PyObject *SaveWindowAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PySaveWindowAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(SaveWindowAttributes);
