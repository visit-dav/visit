...
VISITPY_API PyObject *     PyViewerRPC_getattro(PyObject *self, PyObject *attr_name);
int VISITPY_API            PyViewerRPC_setattro(PyObject *self, PyObject *attr_name, PyObject *args);
