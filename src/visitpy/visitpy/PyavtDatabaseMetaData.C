...
static PyTypeObject avtDatabaseMetaDataType = {
    ...
    .tp_name = "avtDatabaseMetaData",
    .tp_basicsize = sizeof(avtDatabaseMetaDataObject),
    .tp_dealloc = avtDatabaseMetaData_dealloc,
    .tp_repr = avtDatabaseMetaData_str,
    .tp_str = avtDatabaseMetaData_str,
    .tp_getattro = PyavtDatabaseMetaData_getattro,
    .tp_setattro = PyavtDatabaseMetaData_setattro,
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = avtDatabaseMetaData_Purpose,
    .tp_richcompare = avtDatabaseMetaData_richcompare,
    .tp_methods = PyavtDatabaseMetaData_methods};
