...
VISITPY_API PyObject *     PyavtMatSpeciesMetaData_getattro(PyObject *self, PyObject *attr_name);
int VISITPY_API            PyavtMatSpeciesMetaData_setattro(PyObject *self, PyObject *attr_name, PyObject *args);
