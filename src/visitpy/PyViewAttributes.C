...
// Creation:   Tue Mar 26 16:54:14 PST 2002
//
// ****************************************************************************
...
static PyObject *
ViewAttributes_SetCamera(PyObject *self, PyObject *args)
{
    ViewAttributesObject *obj = (ViewAttributesObject *)self;

    double *dvals = obj->data->GetCamera();
    ...
    // Mark the camera in the object as modified.
    obj->data->SelectCamera();
...
static PyObject *
ViewAttributes_GetCamera(PyObject *self, PyObject *args)
{
    ViewAttributesObject *obj = (ViewAttributesObject *)self;
    // Allocate a tuple the with enough entries to hold the camera.
    PyObject *retval = PyTuple_New(3);
    const double *camera = obj->data->GetCamera();
    for(int i = 0; i < 3; ++i)
        PyTuple_SET_ITEM(retval, i, PyFloat_FromDouble(camera[i]));
    return retval;
}
...
static struct PyMethodDef ViewAttributes_methods[] = {
    ...
    {"SetCamera", ViewAttributes_SetCamera, METH_VARARGS},
    {"GetCamera", ViewAttributes_GetCamera, METH_VARARGS},
...
ViewAttributes_getattr(PyObject *self, char *name)
{
    if(strcmp(name, "camera") == 0)
        return ViewAttributes_GetCamera(self, NULL);
...
ViewAttributes_setattr(PyObject *self, char *name, PyObject *args)
{
    ...
    if(strcmp(name, "camera") == 0)
        retval = (ViewAttributes_SetCamera(self, tuple) != NULL);
...
ViewAttributes_add(PyObject *v, PyObject *w)
{
    ...
    c->GetCamera()[0] = a->GetCamera()[0] + b->GetCamera()[0];
    c->GetCamera()[1] = a->GetCamera()[1] + b->GetCamera()[1];
    c->GetCamera()[2] = a->GetCamera()[2] + b->GetCamera()[2];
...
ViewAttributes_mul(PyObject *v, PyObject *w)
{
    ...
    else
    {
        ...
        c->GetCamera()[0] = a->GetCamera()[0] * val;
        c->GetCamera()[1] = a->GetCamera()[1] * val;
        c->GetCamera()[2] = a->GetCamera()[2] * val;
