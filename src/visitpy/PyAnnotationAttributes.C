...
// Creation:   Fri Jan 24 10:52:16 PDT 2003
//
// ****************************************************************************
...
AnnotationAttributes_setattr(PyObject *self, char *name, PyObject *args)
{
    ...
    if(strcmp(name, "axesFlag2D") == 0)
        ...
        retval = (AnnotationAttributes_SetBackgroundColor(self, args) != NULL);
    else if(strcmp(name, "foregroundColor") == 0)
        retval = (AnnotationAttributes_SetForegroundColor(self, args) != NULL);
        ...
        retval = (AnnotationAttributes_SetGradientColor1(self, args) != NULL);
    else if(strcmp(name, "gradientColor2") == 0)
        retval = (AnnotationAttributes_SetGradientColor2(self, args) != NULL);
