...
// Creation:   Wed May 12 07:32:52 PDT 2004
//
// ****************************************************************************
...
PyRenderingAttributes_StringRepresentation(const RenderingAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    if(atts->GetScalableActivationMode() == RenderingAttributes::Never)
        {
             SNPRINTF(tmpStr, 10000, "scalableActivationMode = Never  # %s\n", scalableActivationMode_names);
             str += tmpStr;
        }
    else if(atts->GetScalableActivationMode() == RenderingAttributes::Always)
        {
             SNPRINTF(tmpStr, 10000, "scalableActivationMode = Always  # %s\n", scalableActivationMode_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "scalableActivationMode = Auto  # %s\n", scalableActivationMode_names);
             str += tmpStr;
        }
