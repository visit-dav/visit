...
// Creation:   Mon May 10 09:37:52 PDT 2004
//
// ****************************************************************************
...
RenderingAttributes_SetDisplayListMode(PyObject *self, PyObject *args)
{
    ...
    if(ival >= 0 && ival < 3)
        obj->data->SetDisplayListMode(RenderingAttributes::DisplayListMode(ival));
    else
    {
...
PyRenderingAttributes_StringRepresentation(const RenderingAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    if(atts->GetGeometryRepresentation() == RenderingAttributes::Surfaces)
        {
             SNPRINTF(tmpStr, 10000, "geometryRepresentation = Surfaces  # %s\n", geometryRepresentation_names);
             str += tmpStr;
        }
    else if(atts->GetGeometryRepresentation() == RenderingAttributes::Wireframe)
        {
             SNPRINTF(tmpStr, 10000, "geometryRepresentation = Wireframe  # %s\n", geometryRepresentation_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "geometryRepresentation = Points  # %s\n", geometryRepresentation_names);
             str += tmpStr;
        }
    ...
    if(atts->GetDisplayListMode() == RenderingAttributes::Never)
        {
             SNPRINTF(tmpStr, 10000, "displayListMode = Never  # %s\n", displayListMode_names);
             str += tmpStr;
        }
    else if(atts->GetDisplayListMode() == RenderingAttributes::Always)
        {
             SNPRINTF(tmpStr, 10000, "displayListMode = Always  # %s\n", displayListMode_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "displayListMode = Auto  # %s\n", displayListMode_names);
             str += tmpStr;
        }
    ...
    if(atts->GetStereoType() == RenderingAttributes::RedBlue)
        {
             SNPRINTF(tmpStr, 10000, "stereoType = RedBlue  # %s\n", stereoType_names);
             str += tmpStr;
        }
    else if(atts->GetStereoType() == RenderingAttributes::Interlaced)
        {
             SNPRINTF(tmpStr, 10000, "stereoType = Interlaced  # %s\n", stereoType_names);
             str += tmpStr;
        }
    else
        {
             SNPRINTF(tmpStr, 10000, "stereoType = CrystalEyes  # %s\n", stereoType_names);
             str += tmpStr;
        }
    ...
    str += tmpStr;
    if(atts->GetScalableRendering())
        SNPRINTF(tmpStr, 1000, "scalableRendering = 1\n");
    else
        SNPRINTF(tmpStr, 1000, "scalableRendering = 0\n");
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "scalableThreshold = %d\n", atts->GetScalableThreshold());
    str += tmpStr;
