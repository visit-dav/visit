...
// Creation:   Wed Mar 31 10:30:27 PDT 2004
//
// ****************************************************************************
...
{
    QueryOverTimeAttributesObject *obj = (QueryOverTimeAttributesObject *)self;
    PyObject *retval = PyFloat_FromDouble(obj->data->GetStartTime());
    return retval;
}
...
{
    QueryOverTimeAttributesObject *obj = (QueryOverTimeAttributesObject *)self;
    PyObject *retval = PyFloat_FromDouble(obj->data->GetEndTime());
    return retval;
}
...
PyQueryOverTimeAttributes_StringRepresentation(const QueryOverTimeAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "startTime = %g\n", atts->GetStartTime());
    str += tmpStr;
    ...
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "endTime = %g\n", atts->GetEndTime());
    str += tmpStr;
...
#endif
    {   const intVector &timeSteps = atts->GetTimeSteps();
        SNPRINTF(tmpStr, 1000, "timeSteps = (");
        str += tmpStr;
        for(int i = 0; i < timeSteps.size(); ++i)
        {
            SNPRINTF(tmpStr, 1000, "%d", timeSteps[i]);
            str += tmpStr;
    ...
    {   const doubleVector &timeStates = atts->GetTimeStates();
        SNPRINTF(tmpStr, 1000, "timeStates = (");
        str += tmpStr;
        for(int i = 0; i < timeStates.size(); ++i)
        {
            SNPRINTF(tmpStr, 1000, "%g", timeStates[i]);
            str += tmpStr;
            if(i < timeStates.size() - 1)
            {
                SNPRINTF(tmpStr, 1000, ", ");
                str += tmpStr;
            }
