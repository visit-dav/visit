...
"operator plug-in name that is a member of the tuple returned by the\n"
...
"that contains the name of a valid plot plug-in type which must be a\n"
...
"format reader plug-ins which are tried before any others. These IDs\n"
"are full IDs, not just names, and are tried in order.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"Description:\n"
"\n"
"The LocalNameSpace function tells the VisIt module to add plug-in\n"
...
"Description:\n"
"\n"
"The NumPlotPlugins function returns the number of available plot plug-\n"
"ins.\n"
"\n"
"\n"
"Example:\n"
...
"specify the database plug-in that will be used to open files if all\n"
...
"-assume_format argument allows you to specify the database plug-in\n"
"that will be used FIRST when attempting to open files. This is useful\n"
"when the files that you want to open have a file extension which may\n"
"match multiple file format readers.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"the names of the loaded operator plug-ins. This can be useful for the\n"
...
"names of the loaded plot plug-ins. This can be useful for the creation\n"
"of scripts that alter their behavior based on the available plot plug-\n"
"ins.\n"
"\n"
"\n"
"Example:\n"
