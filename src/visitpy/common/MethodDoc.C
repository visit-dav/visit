...
"making plots or changing timestates. While the OpenDatabase function\n"
...
"the timestates for two or more databases in some way. You would use\n"
...
"visualizing the leading timestates of a database that is still being\n"
"created. If you want to force VisIt to add any new timestates that\n"
...
"which is a VisIt construct that relates the timestates for two or\n"
...
"its own time slider that can be used to set the timestate of\n"
...
"timestate that will be used at a given animation frame when VisIt's\n"
...
"to independently change timestates for each database or you can use a\n"
...
"actual number of timestates in the active database.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"timestates that are used for each animation frame when VisIt is in\n"
"keyframing mode.\n"
"\n"
"\n"
"Example:\n"
...
"all of its timestates as they are being created by a simulation, try\n"
...
"Description:\n"
"\n"
"The SetTimeSliderState function sets the timestate for the active\n"
...
"feature on forces VisIt to re-read metadata each time the timestate\n"
"is changed.\n"
"\n"
"\n"
"Example:\n"
...
"worse the more timestates there are in the database. Ordinarily,\n"
"VisIt does not bother to query each timestate for precise cycle/time\n"
...
"timestates by opening and querying all file(s) in the database.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"Description:\n"
"\n"
"The TimeSliderGetNStates function returns the number of timestates\n"
"for the active time slider. Remember that the length of the time\n"
"slider does not have to be equal to the number of timestates in a\n"
...
"Description:\n"
"\n"
"The TimeSliderSetState function sets the timestate for the active\n"
"time slider. This is the function to use if you want to animate\n"
"through time or change the current keyframe frame.\n"
"\n"
"\n"
...
"When you change the timestate using the time slider for the afore-\n"
...
"time-locked. When you change the timestate using the time slider for\n"
