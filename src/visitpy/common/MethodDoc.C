...
"VisIt 3.4.1. Single Curve Example: #% visit -cli\n"
"OpenDatabase(\"/usr/gapps/visit/data/rect2d.silo\")\n"
"AddPlot(\"Pseudocolor\", \"d\") DrawPlots() Lineout((0, 0), (1, 1))\n"
"SetActiveWindow(2) info = GetPlotInformation() lineout =\n"
"info[\"Curve\"] print(\"The first lineout point is: [%g, %g] \" %\n"
"lineout[0], lineout[1]) Multiple Curve Example: #% visit -cli\n"
"OpenDatabase(\"/usr/gapps/visit/data/wave.visit\")\n"
"AddPlot(\"Pseudocolor\", \"pressure\") DrawPlots()\n"
"PickByNode(domain=0,element=10,do_time=1,vars=(\"pressure\", \"v\"))\n"
"SetActiveWindow(2) info = GetPlotInformation() pressure =\n"
"info[\"Curves\"][\"pressure\"] print(\"The first pressure point is:\n"
"[%g, %g] \" % pressure[0], pressure[1])\n"
;
