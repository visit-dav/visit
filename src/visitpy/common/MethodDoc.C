...
"function does not have any side effects that would cause the timestate\n"
"for the new active database to be changed.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"databases in some way. You would use the CreateDatabaseCorrelation\n"
"function if you wanted to put plots from more than one time-varying\n"
"database in the same vis window and then move them both through time\n"
"in some synchronized way. The name argument is a string that is the\n"
"name of the database correlation to be created. You will use the name\n"
"of the database correlation to set the active time slider later so\n"
"that you can change time states. The databases argument is a list or\n"
"tuple of string objects containing the fully-qualified\n"
"(host:/path/filename) names of the databases to be involved in the\n"
"database query. The method argument allows you to specify a database\n"
"correlation method. Each database correlation has its own time slider\n"
"that can be used to set the timestate of databases that are part of a\n"
"database correlation. Individual time-varying databases have their own\n"
"trivial database correlation, consisting of only 1 database. When you\n"
"call the CreateDatabaseCorrelation function, VisIt creates a new time\n"
"slider with the same name as the database correlation and makes it be\n"
...
"slider. This is the function to use if you want to animate through\n"
"time or change the current keyframe frame.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"feature on forces VisIt to re-read metadata each time the timestate is\n"
"changed.\n"
"\n"
"\n"
"Example:\n"
...
"worse the more timestates there are in the database. Ordinarily, VisIt\n"
"does not bother to query each timestate for precise cycle/time\n"
...
"the active time slider. Remember that the length of the time slider\n"
"does not have to be equal to the number of timestates in a time-\n"
"varying database because of database correlations and keyframing. If\n"
"you want to iterate through time, use this function to determine the\n"
"number of iterations that are required to reach the end of the active\n"
"time slider.\n"
"\n"
"\n"
"Example:\n"
