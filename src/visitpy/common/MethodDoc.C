...
"Python scripts that only need access to VisIt's capabilities for a\n"
...
"the active plot. Data Binnings place data from a dataset into bins and\n"
"reduce that data. They are used to either be incorporated with\n"
...
"from a specific plot. A database keyframe represents the database\n"
"time-state that will be used at a given animation frame when VisIt's\n"
...
"selection is defined, and a summary that describes the data that was\n"
...
"plot to a new animation frame, which changes the list of database\n"
"time-states that are used for each animation frame when VisIt is in\n"
"keyframing mode.\n"
"\n"
"\n"
"Example:\n"
...
"one timestep to the next. However, sometimes, portions of the\n"
...
"filename(s) comprising the database. However, turning this feature on\n"
...
"When you change the time-state using the time slider for the afore-\n"
"mentioned database correlation, it has the effect of updating time in\n"
"all time-locked visualization windows.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"the afore-mentioned database correlation, it has the effect of\n"
