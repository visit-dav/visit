...
"variables are used in the Label plot. The variableName argument is\n"
"either a string that contains the name of the variable to define or a\n"
"list of strings with the names of the variables to define. If you are\n"
"going to define more than about a hundred expressions you should use\n"
"the list version to get good performance. If you use the list version\n"
"the number of variable names must match the number of definitions. If\n"
"you pass the name of an existing expression it will replace the\n"
"current definition. The expression argument is a string that contains\n"
"the definition of the new variable in terms of built-in expressions\n"
"<Built-in_expressions>` and pre-existing variable names using VisIt's\n"
":ref:`expression grammar. If you run into problems defining your\n"
"expression you might want to read the section on expression\n"
"compatibility gotchas. The function will throw an exception if the\n"
"list of strings is incorrectly formed or when the number of variable\n"
"names does not match the number of definitions.\n"
"\n"
"\n"
"Example:\n"
"\n"
...
"plots. The variableName argument is either a string that contains the\n"
"name of the variable to define or a list of strings with the names of\n"
"the variables to define. If you are going to define more than about a\n"
"hundred expressions you should use the list version to get good\n"
"performance. If you use the list version the number of variable names\n"
"must match the number of definitions. If you pass the name of an\n"
"existing expression it will replace the current definition. The\n"
"expression argument is a string that contains the definition of the\n"
"new variable in terms of built-in expressions <Built-in_expressions>`\n"
"and pre-existing variable names using VisIt's :ref:`expression\n"
"grammar. If you run into problems defining your expression you might\n"
"want to read the section on expression compatibility gotchas. The\n"
"function will throw an exception if the list of strings is incorrectly\n"
"formed or when the number of variable names does not match the number\n"
"of definitions.\n"
"\n"
"\n"
"Example:\n"
...
"and Filled Boundary plots. The variableName argument is either a\n"
"string that contains the name of the variable to define or a list of\n"
"strings with the names of the variables to define. If you are going to\n"
"define more than about a hundred expressions you should use the list\n"
"version to get good performance. If you use the list version the\n"
"number of variable names must match the number of definitions. If you\n"
"pass the name of an existing expression it will replace the current\n"
"definition. Currently there are no built-in expressions that create\n"
"material variables. The function will throw an exception if the list\n"
"of strings is incorrectly formed or when the number of variable names\n"
"does not match the number of definitions.\n"
;
...
"the Label, Mesh and Subset plots. The variableName argument is either\n"
"a string that contains the name of the variable to define or a list of\n"
"strings with the names of the variables to define. If you are going to\n"
"define more than about a hundred expressions you should use the list\n"
"version to get good performance. If you use the list version the\n"
"number of variable names must match the number of definitions. If you\n"
"pass the name of an existing expression it will replace the current\n"
"definition. Currently there are no built-in expressions that create\n"
"mesh variables. The function will throw an exception if the list of\n"
"strings is incorrectly formed or when the number of variable names\n"
"does not match the number of definitions.\n"
;
...
"scalar variables. The variableName argument is either a string that\n"
"contains the name of the variable to define or a list of strings with\n"
"the names of the variables to define. If you are going to define more\n"
"than about a hundred expressions you should use the list version to\n"
"get good performance. If you use the list version the number of\n"
"variable names must match the number of definitions. If you pass the\n"
"name of an existing expression it will replace the current definition.\n"
"The expression argument is a string that contains the definition of\n"
"the new variable in terms of built-in expressions <Built-\n"
"in_expressions>` and pre-existing variable names using VisIt's\n"
":ref:`expression grammar. If you run into problems defining your\n"
"expression you might want to read the section on expression\n"
"compatibility gotchas. The function will throw an exception if the\n"
"list of strings is incorrectly formed or when the number of variable\n"
...
"variables that store species information for scalar variables. The\n"
"variableName argument is either a string that contains the name of the\n"
"variable to define or a list of strings with the names of the\n"
"variables to define. If you are going to define more than about a\n"
"hundred expressions you should use the list version to get good\n"
"performance. If you use the list version the number of variable names\n"
"must match the number of definitions. If you pass the name of an\n"
"existing expression it will replace the current definition. Currently\n"
"there are no built-in expressions that create species variables. The\n"
"function will throw an exception if the list of strings is incorrectly\n"
"formed or when the number of variable names does not match the number\n"
"of definitions.\n"
;
...
"3 components. The variableName argument is either a string that\n"
"contains the name of the variable to define or a list of strings with\n"
"the names of the variables to define. If you are going to define more\n"
"than about a hundred expressions you should use the list version to\n"
"get good performance. If you use the list version the number of\n"
...
"makes the visualization window with the smallest window identifier the\n"
"new active window. This function has no effect when there is only one\n"
...
"Description:\n"
"\n"
"The RestoreSession function is useful for setting up complex\n"
...
"Description:\n"
"\n"
"The RestoreSessionWithDifferentSources function is useful for setting\n"
"up complex visualizations because you can design a VisIt session file,\n"
"which is an XML file that describes exactly how plots are set up,\n"
"using the VisIt GUI and then use that same session file in the CLI as\n"
"a template for generating the same visualizations from other data\n"
"files.\n"
"\n"
"\n"
"Example:\n"
...
"very important to be able to set the active window. Use the\n"
"SetActiveWindow function to do this. This function takes a single\n"
"integer argument which is the identifier of the new active window. As\n"
"windows are added with AddWindow() and deleted with DeleteWindow(),\n"
"the list of available windows (which can be obtained with\n"
"GetGlobalAttributes().windows can wind up looking like an arbitrary\n"
"set of positive integers such as (1,2,4,7,8). These numbers are also\n"
"the same numbers that appear in window title strings in the window\n"
"manager. The active window is NOT a 0-based index over the number of\n"
"available windows. The active window is identified as one of the\n"
...
"DrawPlots()\n"
;
const char *visit_GetActiveWindow_doc = 
"GetActiveWindow\n"
"\n"
"\n"
"Synopsis:\n"
