...
// Creation:   Sat Feb 25 13:51:50 PST 2006
//
// ****************************************************************************
...
PyConstructDDFAttributes_ToString(const ConstructDDFAttributes *atts, const char *prefix)
{
    ...
    str += tmpStr;
    const char *statisticalOperator_names = "Average, Minimum, Maximum, StandardDeviation, Variance, Percentile, Median, InterquartileRange, Sum";
...
ConstructDDFAttributes_SetStatisticalOperator(PyObject *self, PyObject *args)
{
    ...
    else
    {
        fprintf(stderr, "An invalid statisticalOperator value was given. "
                        ...
                        "Average, Minimum, Maximum, StandardDeviation, Variance, Percentile, Median, InterquartileRange, Sum.");
        return NULL;
    }
...
PyObject *
PyConstructDDFAttributes_NewPyObject()
{
    return NewConstructDDFAttributes(0);
}

PyObject *
PyConstructDDFAttributes_WrapPyObject(const ConstructDDFAttributes *attr)
{
