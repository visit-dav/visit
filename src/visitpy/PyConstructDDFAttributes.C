...
// Creation:   Mon Feb 20 10:42:52 PDT 2006
//
// ****************************************************************************
...
PyConstructDDFAttributes_ToString(const ConstructDDFAttributes *atts, const char *prefix)
{
    ...
    str += tmpStr;
    const char *statisticalOperator_names = "Average, Minimum, Maximum, StandardDeviation, Variance, Percentile, Median, InterquartileRange, Mode, Sum";
    ...
    else if(atts->GetStatisticalOperator() == ConstructDDFAttributes::Mode)
    {
        SNPRINTF(tmpStr, 1000, "%sstatisticalOperator = %sMode  # %s\n", prefix, prefix, statisticalOperator_names);
        str += tmpStr;
    }
    else
    {
...
ConstructDDFAttributes_SetStatisticalOperator(PyObject *self, PyObject *args)
{
    ...
    else
    {
        fprintf(stderr, "An invalid statisticalOperator value was given. "
                        ...
                        "Average, Minimum, Maximum, StandardDeviation, Variance, Percentile, Median, InterquartileRange, Mode, Sum.");
        return NULL;
    }
...
ConstructDDFAttributes_getattr(PyObject *self, char *name)
{
    ...
    if(strcmp(name, "Average") == 0)
        ...
        return PyInt_FromLong(long(ConstructDDFAttributes::Mode));
