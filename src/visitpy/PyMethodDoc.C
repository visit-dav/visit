...
"creates new species variables, and DefineVectorExpression creates new\n"
"vector variables. Expression variables can be plotted like any other\n"
"variable. The variableName argument is a string that contains the name of\n"
"the new variable. The expression argument is a string that contains the\n"
"definition of the new variable in terms of math operators and pre-existing\n"
"variable names. Reference the VisIt User's Manual if you want more\n"
"information on creating expressions, such as expression syntax, or a list\n"
"of built-in expression functions.\n"
"\n"
"\n"
"Example:\n"
"\n"
