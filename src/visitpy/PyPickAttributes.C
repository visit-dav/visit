...
// Creation:   Thu Nov 17 11:49:29 PDT 2005
//
// ****************************************************************************
...
PyPickAttributes_StringRepresentation(const PickAttributes *atts)
{
   ...
   char tmpStr[1000]; 
    ...
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "ghostType = %d\n", atts->GetGhostType());
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "hasMixedGhostTypes = %d\n", atts->GetHasMixedGhostTypes());
    str += tmpStr;
    if(atts->GetLinesData())
        SNPRINTF(tmpStr, 1000, "linesData = 1\n");
    else
        SNPRINTF(tmpStr, 1000, "linesData = 0\n");
    str += tmpStr;
    SNPRINTF(tmpStr, 1000, "inputTopoDim = %d\n", atts->GetInputTopoDim());
    str += tmpStr;
