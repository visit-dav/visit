...
TestSection("ElementBlock*1 Expression")
OpenDatabase(data_path("exodus_test_data/aircraft.exoII"))
DefineScalarExpression("foo", "ElementBlock*1")
AddPlot("Pseudocolor","foo")
DrawPlots()
ResetView()
Query("MinMax")
q = GetQueryOutputObject()
TestValueEQ("ElementBlock*1 expr min", q['min'], 1)
TestValueEQ("ElementBlock*1 expr max", q['max'], 2)
DeleteAllPlots() 
CloseDatabase(data_path("exodus_test_data/aircraft.exoII"))
