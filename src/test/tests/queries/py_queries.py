...
#PythonQuery(file=script_path("py_query_script_00.vpq"),vars=["default","p"],args=["test",0.0,[1,2.0,3]])
PythonQuery(file=script_path("py_query_script_01.vpq"),vars=["default","p"])
res = GetQueryOutputString()
