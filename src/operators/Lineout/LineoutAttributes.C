...
LineoutAttributes::LineoutAttributes() : AttributeSubject("DDbibbs")
{
    point1[0] = 0;
    point1[1] = 0;
    point1[2] = 0;
...
LineoutAttributes::LineoutAttributes(const LineoutAttributes &obj) : AttributeSubject("DDbibbs")
{
...
LineoutAttributes::SelectAll()
{
    ...
    Select(2, (void *)&samplingOn);
    Select(3, (void *)&numberOfSamplePoints);
    Select(4, (void *)&interactive);
    Select(5, (void *)&reflineLabels);
    Select(6, (void *)&designator);
}
...
LineoutAttributes::GetFieldName(int index) const
{
    switch (index)
    {
        ...
        case 2:  return "samplingOn";
        case 3:  return "Number of Sample Points ";
        case 4:  return "Interactive";
        case 5:  return "Refline Labels";
        case 6:  return "Designator";
