...
static PyObject *CartographicProjectionAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PyCartographicProjectionAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(CartographicProjectionAttributes);
