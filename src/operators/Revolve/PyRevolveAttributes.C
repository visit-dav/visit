...
static PyTypeObject RevolveAttributesType =
{
    ...
    (getattrfunc)PyRevolveAttributes_getattr, /* tp_getattr */
    (setattrfunc)PyRevolveAttributes_setattr, /* tp_setattr */
    0,                                 /* tp_reserved */
    0,                                 /* tp_repr */
    0,                                 /* tp_as_number */
    0,                                 /* tp_as_sequence */
    ...
    0,                                 /* tp_traverse */
    0,                                 /* tp_clear */
   (richcmpfunc)RevolveAttributes_richcompare,  /* tp_richcompare */
    0,                                 /* tp_weaklistoffset */
//
