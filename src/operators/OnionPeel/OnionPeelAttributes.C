...
OnionPeelAttributes::OnionPeelAttributes() : AttributeSubject("ibssi*bi")
{
    adjacencyType = Node;
    useGlobalId = false;
    categoryName = "Whole";
...
OnionPeelAttributes::OnionPeelAttributes(const OnionPeelAttributes &obj) : AttributeSubject("ibssi*bi")
{
