...
PDFScriptingPluginInfo::InitializePlugin(AttributeSubject *subj,
    FILE *logFile)
{
    PyPDFAttributes_StartUp((PDFAttributes *)subj, logFile);
}
...
// ****************************************************************************
// Method: PDFScriptingPluginInfo::SetLogging
//
// Purpose: 
...
void
PDFScriptingPluginInfo::SetLogging(bool val)
{
    PyPDFAttributes_SetLogging(val);
}
