...
static PyObject *SurfaceNormalAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PySurfaceNormalAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(SurfaceNormalAttributes);
