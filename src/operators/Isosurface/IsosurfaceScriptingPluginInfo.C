...
//
//  Purpose:
//    Return a new ScriptingPluginInfo for the Isosurface plot.
//
//  Programmer: whitlocb -- generated by xml2info
//  Creation:   Mon May 6 15:36:51 PST 2002
//
// ****************************************************************************
...
IsosurfaceScriptingPluginInfo::InitializePlugin(AttributeSubject *subj,
    FILE *logFile)
{
    PyIsosurfaceAttributes_StartUp((IsosurfaceAttributes *)subj, logFile);
}
...
// ****************************************************************************
// Method: IsosurfaceScriptingPluginInfo::SetLogging
//
// Purpose: 
...
void
IsosurfaceScriptingPluginInfo::SetLogging(bool val)
{
    PyIsosurfaceAttributes_SetLogging(val);
}
