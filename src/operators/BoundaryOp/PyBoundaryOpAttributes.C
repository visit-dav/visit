...
static PyObject *BoundaryOpAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PyBoundaryOpAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(BoundaryOpAttributes);
