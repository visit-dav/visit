...
static PyObject *ThreeSliceAttributes_dir(PyObject *self, PyObject *args);

static PyMethodDef PyThreeSliceAttributes_methods[] = {
...
//
VISIT_PY_TYPE_OBJ(ThreeSliceAttributes);
