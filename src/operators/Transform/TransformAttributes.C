...
TransformAttributes::TransformAttributes() : AttributeSubject("bFFfibFfffbfff")
{
    doRotate = false;
    rotateOrigin[0] = 0;
    rotateOrigin[1] = 0;
...
TransformAttributes::TransformAttributes(const TransformAttributes &obj) : AttributeSubject("bFFfibFfffbfff")
{
...
bool
TransformAttributes::CreateNode(DataNode *parentNode, bool forceAdd)
{
    if(parentNode == 0)
        return false;
