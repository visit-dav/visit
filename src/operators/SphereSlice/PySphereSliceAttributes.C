...
// Internal prototypes
//
static PyObject *NewSphereSliceAttributes();
...
SphereSliceAttributes_setattr(PyObject *self, char *name, PyObject *args)
{
    ...
    if(strcmp(name, "origin") == 0)
        retval = (SphereSliceAttributes_SetOrigin(self, tuple) != NULL);
    else if(strcmp(name, "radius") == 0)
        retval = (SphereSliceAttributes_SetRadius(self, tuple) != NULL);
...
SphereSliceAttributes_new(PyObject *self, PyObject *args)
{
    if (!PyArg_ParseTuple(args, ""))
        return NULL;
    return (PyObject *)NewSphereSliceAttributes();
}
...
static bool SphereSliceAttributesEnableLogging = true;

static void
PySphereSliceAttributes_WriteLog(Subject *subj, void *data)
{
    SphereSliceAttributes *atts = (SphereSliceAttributes *)subj;
    FILE *logFile = (FILE *)data;

    if(!SphereSliceAttributesEnableLogging || (logFile == NULL))
        return;

    fprintf(logFile, "# SphereSliceAttributes_WriteLog()\n");
}

void
PySphereSliceAttributes_StartUp(SphereSliceAttributes *subj, FILE *logFile)
{
    if(subj == 0)
        return;
    ...
    if(SphereSliceAttributesObserver == 0)
    {
        SphereSliceAttributesObserver = new ObserverToCallback(subj,
            PySphereSliceAttributes_WriteLog, (void *)logFile);
    }

    SphereSliceAttributesEnableLogging = true;
}
...
PyObject *
PySphereSliceAttributes_NewPyObject()
{
    return NewSphereSliceAttributes();
}

PyObject *
PySphereSliceAttributes_WrapPyObject(const SphereSliceAttributes *attr)
{
    return WrapSphereSliceAttributes(attr);
}

void
PySphereSliceAttributes_SetLogging(bool val)
{
    SphereSliceAttributesEnableLogging = val;
}
