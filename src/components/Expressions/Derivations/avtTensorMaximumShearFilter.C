...
// ****************************************************************************
//  Method: avtTensorMaximumShearFilter constructor
//
//  Purpose:
...
avtTensorMaximumShearFilter::avtTensorMaximumShearFilter()
{
    ;
}
...
// ****************************************************************************
//  Method: avtTensorMaximumShearFilter destructor
//
//  Purpose:
...
// ****************************************************************************
//  Method: avtTensorMaximumShearFilter::DoOperation
//
//  Purpose:
...
void
avtTensorMaximumShearFilter::DoOperation(vtkDataArray *in, vtkDataArray *out,
