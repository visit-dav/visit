...
// ****************************************************************************
//  Method: avtVectorComponent3Filter::DeriveVariable
//
//  Purpose:
...
vtkDataArray *
avtVectorComponent3Filter::DeriveVariable(vtkDataSet *in_ds)
{
    ...
    {
        float val = arr->GetComponent(i, 2);
        rv->SetTuple1(i, val);
    }
