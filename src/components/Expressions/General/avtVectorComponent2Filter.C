...
// ****************************************************************************
//  Method: avtVectorComponent2Filter::DeriveVariable
//
//  Purpose:
...
vtkDataArray *
avtVectorComponent2Filter::DeriveVariable(vtkDataSet *in_ds)
{
    ...
    {
        float val = arr->GetComponent(i, 1);
        rv->SetTuple1(i, val);
    }
