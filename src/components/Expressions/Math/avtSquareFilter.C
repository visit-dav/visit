...
// ****************************************************************************
//  Method: avtSquareFilter constructor
//
//  Purpose:
...
avtSquareFilter::avtSquareFilter()
{
    ;
}
...
// ****************************************************************************
//  Method: avtSquareFilter destructor
//
//  Purpose:
...
// ****************************************************************************
//  Method: avtSquareFilter::DoOperation
//
//  Purpose:
...
void
avtSquareFilter::DoOperation(vtkDataArray *in, vtkDataArray *out,
