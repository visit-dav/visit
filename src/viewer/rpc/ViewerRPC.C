...
"MoveWindowRPC", "MoveAndResizeWindowRPC", "MaxRPC"
};
...
//
// Programmer: xml2atts
// Creation:   Thu Nov 17 17:20:31 PST 2005
//
// Modifications:
//   
// ****************************************************************************

ViewerRPC::ViewerRPC() : AttributeSubject("iiiisssss*iiIiiisi*i*i*ssDDs*ibiiiss")
{
    RPCType = CloseRPC;
    windowLayout = 1;
    windowId = 0;
...
ViewerRPC::ViewerRPC(const ViewerRPC &obj) : AttributeSubject("iiiisssss*iiIiiisi*i*i*ssDDs*ibiiiss")
{
    RPCType = obj.RPCType;
