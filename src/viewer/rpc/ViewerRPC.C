...
"ShowToolbarsRPC", "ShowToolbarsForAllWindowsRPC", "SaveViewRPC", 
"SetGlobalLineoutAttributesRPC", "SetPickAttributesRPC", "MaxRPC"
};

std::string
ViewerRPC::ViewerRPCType_ToString(ViewerRPC::ViewerRPCType t)
{
    return ViewerRPCType_strings[(int)t];
}

std::string
ViewerRPC::ViewerRPCType_ToString(int t)
{
    return ViewerRPCType_strings[t];
}
...
//
// Programmer: xml2atts
// Creation:   Tue Jul 1 10:36:37 PDT 2003
//
// Modifications:
//   
// ****************************************************************************
...
ViewerRPC::SetFromNode(DataNode *parentNode)
{
    ...
    if((node = searchNode->GetNode("RPCType")) != 0)
    {
        ...
        if(node->GetNodeType() == INT_NODE)
            SetRPCType(ViewerRPCType(node->AsInt()));
