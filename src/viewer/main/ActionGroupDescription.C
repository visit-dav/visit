...
ActionGroupDescription::ActionGroupDescription() : AttributeSubject("ss*b")
{
    visible = true;
}
...
ActionGroupDescription::ActionGroupDescription(const ActionGroupDescription &obj) : AttributeSubject("ss*b")
{
    name = obj.name;
    actions = obj.actions;
    visible = obj.visible;
...
bool
ActionGroupDescription::CreateNode(DataNode *parentNode, bool forceAdd)
{
    if(parentNode == 0)
        return false;
