/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItPointLocator.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkVisItPointLocator - quickly locate points in 3-space
// .SECTION Description
// vtkVisItPointLocator is a spatial search object to quickly locate points in 3D.
// vtkVisItPointLocator works by dividing a specified region of space into a regular
...
//
// vtkVisItPointLocator has two distinct methods of interaction. In the first
