/*=========================================================================
  ...
  Module:    $RCSfile: vtkVisItExtractRectilinearGrid.C,v $
...
vtkCxxRevisionMacro(vtkVisItExtractRectilinearGrid, "$Revision: 1.5 $");
...
void vtkVisItExtractRectilinearGrid::SetInput(vtkRectilinearGrid *input)
{
...
//----------------------------------------------------------------------------
// Specify the input data or filter.
vtkRectilinearGrid *vtkVisItExtractRectilinearGrid::GetInput()
{
...
//----------------------------------------------------------------------------
void vtkVisItExtractRectilinearGrid::ComputeInputUpdateExtents(vtkDataObject *vtkNotUsed(out))
{
...
//----------------------------------------------------------------------------
void vtkVisItExtractRectilinearGrid::ExecuteInformation()
{
  vtkRectilinearGrid *input= this->GetInput();
  vtkRectilinearGrid *output= this->GetOutput();
...
//
// ****************************************************************************
void vtkVisItExtractRectilinearGrid::Execute()
{
  vtkRectilinearGrid *input= this->GetInput();
