...
//----------------------------------------------------------------------------
void vtkVisItExtractCellsByType::AddCellType(unsigned int cellType)
{
...
//----------------------------------------------------------------------------
void vtkVisItExtractCellsByType::RemoveCellType(unsigned int cellType)
{
  auto prevSize = this->CellTypes->size();
...
//----------------------------------------------------------------------------
void vtkVisItExtractCellsByType::RemoveAllCellTypes()
{
...
void vtkVisItExtractCellsByType::AddAllCellTypes()
{
  auto prevSize = this->CellTypes->size();
...
//----------------------------------------------------------------------------
bool vtkVisItExtractCellsByType::ExtractCellType(unsigned int cellType)
{
...
//----------------------------------------------------------------------------
void vtkVisItExtractCellsByType::
...
//----------------------------------------------------------------------------
int vtkVisItExtractCellsByType::RequestData(
...
//----------------------------------------------------------------------------
int vtkVisItExtractCellsByType::FillInputPortInformation(int, vtkInformation *info)
{
...
//----------------------------------------------------------------------------
void vtkVisItExtractCellsByType::PrintSelf(ostream& os, vtkIndent indent)
{
