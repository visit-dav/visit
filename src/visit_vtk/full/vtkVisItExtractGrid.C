  ...
  vtkInformationVector *outputVector)
{
  ...
  shift[0] = static_cast<int>(floor(static_cast<float>(voi[0])/
                                    static_cast<float>(rate[0])));
  shift[1] = static_cast<int>(floor(static_cast<float>(voi[2])/
                                    static_cast<float>(rate[1])));
  shift[2] = static_cast<int>(floor(static_cast<float>(voi[4])/
