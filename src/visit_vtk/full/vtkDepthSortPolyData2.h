...
#include <visit_vtk_exports.h> // For visit export macro
//#include "vtkFiltersHybridModule.h" // For vtk export macro
...
class VISIT_VTK_API vtkDepthSortPolyData2 : public vtkPolyDataAlgorithm
{
public:
  // Description:
  // Instantiate object.
